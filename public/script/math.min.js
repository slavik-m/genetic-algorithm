...
!function (e, r) {
	...
	return function (e) {
		...
		function t(e) {
			...
			var r = {}, a = {matrix: "matrix", number: "number", precision: 64, epsilon: 1e-14};
			r.config = function (e) {
				if (e) {
					if (i.deepExtend(a, e), e.precision && r.type.BigNumber.config({precision: e.precision}), n(2)(r, a), e.number && e.number.defaultType)throw new Error("setting `number.defaultType` is deprecated. Use `number` instead.");
			...
			var s = n(139).constructor();
			if ("function" != typeof s.prototype.clone && (s.prototype.clone = function () {
					return new s(this)
			...
			},n(2)(r, a),n(18)(r, a),n(19)(r, a),n(20)(r, a),n(21)(r, a),n(22)(r, a),n(23)(r, a),n(24)(r, a),n(25)(r, a),n(26)(r, a),n(27)(r, a),r.chaining = {},r.chaining.Selector = n(28)(r, a),r.config(a),r.config(e),r
		}

		var i = n(3), o = n(4).digits, a = t();
		...
		e.exports = function (e, r) {
			...
			function i() {
				return new f(1).plus(new f(5).sqrt()).div(2)
			}

			function o(e) {
				for (var r = e, n = 0 / 0, t = e.times(e), i = e, o = -1, a = 3; !r.equals(n); a += 2)i = i.times(t), n = r, r = o > 0 ? r.plus(i.div(a)) : r.minus(i.div(a)), o = -o;
				return r
			}

			function a() {
				var e = f.constructor({precision: f.precision + 4}), r = new e(4).times(o(new e(1).div(5))).minus(o(new e(1).div(239)));
				return new f(4).times(r)
			}

			function s() {
				f.config({precision: r.precision + 2});
				var e = a();
				return f.config({precision: r.precision}), new f(2).times(e)
			}

			var u = (n(136), n(6)), f = e.type.BigNumber, c = "bignumber" === r.number;
			e.pi = c ? a() : Math.PI, e.tau = c ? s() : 2 * Math.PI, e.e = c ? t() : Math.E, e.phi = c ? i() : 1.618033988749895, e.i = new u(0, 1), e.Infinity = 1 / 0, e.NaN = 0 / 0, e["true"] = !0, e["false"] = !1, e["null"] = null, e.uninitialized = n(137).UNINITIALIZED, e.E = e.e, e.LN2 = c ? new f(2).ln() : Math.LN2, e.LN10 = c ? new f(10).ln() : Math.LN10, e.LOG2E = c ? new f(1).div(new f(2).ln()) : Math.LOG2E, e.LOG10E = c ? new f(1).div(new f(10).ln()) : Math.LOG10E, e.PI = e.pi, e.SQRT1_2 = c ? new f(.5).sqrt() : Math.SQRT1_2, e.SQRT2 = c ? new f(2).sqrt() : Math.SQRT2, e.version = n(138)
		}
	}, function (e, r) {
		"use strict";
		r.clone = function n(e) {
			...
			for (var n in r)if (r.hasOwnProperty(n))if (r[n] && r[n].constructor === Object)void 0 === e[n] && (e[n] = {}), e[n].constructor === Object ? t(e[n], r[n]) : e[n] = r[n]; else {
			...
			if (Array.isArray(e)) {
				...
				for (i = 0, o = e.length; o > i; i++)if (!r.deepEqual(e[i], n[i]))return !1;
				return !0
			}
			if (e instanceof Object) {
				if (Array.isArray(n) || !(n instanceof Object))return !1;
				for (t in e)if (!r.deepEqual(e[t], n[t]))return !1;
				for (t in n)if (!r.deepEqual(e[t], n[t]))return !1;
				return !0
			}
		...
		r.isNumber = function (e) {
			...
			var t = "auto", i = void 0;
			switch (n && (n.notation && (t = n.notation), r.isNumber(n) ? i = n : n.precision && (i = n.precision)), t) {
				case"fixed":
				...
				case"auto":
					...
					return s.replace(/((\.\d*?)(0+))($|e)/, function () {
						var e = arguments[2], r = arguments[4];
						return "." !== e ? e + r : r
					});
				default:
		...
		"use strict";
		r.ArgumentsError = n(140), r.DimensionError = n(141), r.IndexError = n(142), r.UnsupportedTypeError = n(143)
	}, function (e, r, n) {
		"use strict";
		function t(e, r) {
		...
		function f() {
			var e, r = "";
			if (e = y, "+" == w ? s() : "-" == w && (r += w, s()), !o(w))return u(e), null;
			if ("." == w) {
				if (r += w, s(), !a(w))return u(e), null
			} else {
				for (; a(w);)r += w, s();
				"." == w && (r += w, s())
			}
			for (; a(w);)r += w, s();
			if ("E" == w || "e" == w) {
				if (r += w, s(), ("+" == w || "-" == w) && (r += w, s()), !a(w))return u(e), null;
				for (; a(w);)r += w, s()
			}
			return r
		}
		...
		var l = n(144), p = n(10), m = l.number, h = l.number.isNumber, g = p.isUnit, d = l.string.isString;
		t.isComplex = function (e) {
			return e instanceof t
		};
		var x, y, w;
		t.parse = function (e) {
			if (x = e, y = -1, w = "", !d(x))return null;
			s(), i();
			var r = f();
			if (r) {
				if ("I" == w || "i" == w)return s(), i(), w ? null : new t(0, Number(r));
				i();
				var n = w;
				if ("+" != n && "-" != n)return i(), w ? null : new t(Number(r), 0);
				s(), i();
				var o = f();
				if (o) {
					if ("I" != w && "i" != w)return null;
					s()
				} else if (o = c(), !o)return null;
				return "-" == n && (o = "-" == o[0] ? "+" + o.substring(1) : "-" + o), s(), i(), w ? null : new t(Number(r), Number(o))
			}
			return (r = c()) ? (i(), w ? null : new t(0, Number(r))) : null
			...
			var r = "", n = m.format(this.re, e), t = m.format(this.im, e);
			...
			return this.format()
		}, t.prototype.valueOf = t.prototype.toString, e.exports = t
	}, function (e, r, n) {
		"use strict";
		function t(e, r, n) {
			if (!(this instanceof t))throw new SyntaxError("Constructor must be called with the new operator");
		...
		{
			var i = n(144), o = i.number, a = i.string;
			i.array
		}
		t.parse = function (e) {
			if (!a.isString(e))return null;
			var r = e.split(":"), n = r.map(function (e) {
				return parseFloat(e)
			}), i = n.some(function (e) {
				return isNaN(e)
			});
			...
			var e = 0, r = this.start, n = this.step, t = this.end, i = t - r;
			...
			var r = this.start, n = this.step, t = this.end, i = 0;
			if (n > 0)for (; t > r;)e(r, i, this), r += n, i++; else if (0 > n)for (; r > t;)e(r, i, this), r += n, i++
		...
		function t() {
			...
			for (var e = 0, r = arguments.length; r > e; e++) {
				var n = arguments[e];
				if (n instanceof a)this._ranges.push(n), this._isScalar = !1; else if (c(n))this._ranges.push(i(n)), this._isScalar = !1; else if (u(n))this._ranges.push(i([n, n + 1])); else {
					var o = n.valueOf();
					if (!c(o))throw new TypeError("Ranges must be an Array, Number, or Range");
					this._ranges.push(i(o)), this._isScalar = !1
				}
			}
		}

		function i(e) {
			for (var r = e.length, n = 0; r > n; n++)if (!u(e[n]) || !f(e[n]))throw new TypeError("Index parameters must be integer numbers");
			switch (e.length) {
				case 2:
		...
		var o = n(144), a = n(7), s = o.number, u = s.isNumber, f = s.isInteger, c = Array.isArray;
		t.prototype.clone = function () {
			var e = new t;
			...
			for (var e = [], r = 0, n = this._ranges.length; n > r; r++) {
				var t = this._ranges[r], i = [], o = t.start, a = t.end, s = t.step;
				if (s > 0)for (; a > o;)i.push(o), o += s; else if (0 > s)for (; o > a;)i.push(o), o += s;
				e.push(i)
			}
			return e
		}, t.prototype.valueOf = t.prototype.toArray, t.prototype.toString = function () {
			for (var e = [], r = 0, n = this._ranges.length; n > r; r++) {
				var t = this._ranges[r], i = s.format(t.start);
		...
		function t(e) {
			if (!(this instanceof t))throw new SyntaxError("Constructor must be called with the new operator");
			if (e instanceof t)this._data = e.clone()._data; else if (d(e))this._data = f(e); else {
		...
		function i(e, r) {
			...
			for (var a = r.min(), s = r.max(), u = 0, f = e._size.length; f > u; u++)x(a[u], e._size[u]), x(s[u], e._size[u]);
			return new t(o(e._data, r, i.length, 0))
		}

		function o(e, r, n, t) {
			var i = t == n - 1, a = r.range(t);
		...
		function a(e, r, n, i) {
			...
			if (n instanceof t ? (o = n.size(), n = n.valueOf()) : o = h.size(n), f) {
				...
				if (o.length < a.length) {
					for (var c = 0, m = 0; 1 === a[c] && 1 === o[c];)c++;
					for (; 1 === a[c];)m++, c++;
					n = h.unsqueeze(n, a.length, m, o)
				}
		...
		function u(e, r, n) {
			for (var t = g.clone(e._size), i = !1; t.length < r.length;)t.push(0), i = !0;
		...
		var c = n(144), l = n(141), p = n(8), m = (c.number, c.string), h = c.array, g = c.object, d = Array.isArray, x = h.validateIndex;
		t.isMatrix = function (e) {
			...
			var r = this, n = new t, i = [], o = function (n, t) {
		...
		function t(e, r) {
			...
			if (void 0 != r && (!w(r) || "" == r))throw new TypeError("Second parameter in Unit constructor must be a string");
			if (void 0 != r) {
				var n = l(r);
		...
		function l(e) {
			for (var r in T)if (T.hasOwnProperty(r) && x.endsWith(e, r)) {
				var n = T[r], t = e.length - r.length, i = e.substring(0, t), o = n.prefixes[i];
				if (void 0 !== o)return {unit: n, prefix: o}
			}
			return null
		}

		var p, m, h, g = n(144), d = g.number, x = g.string, y = g.number.isNumber, w = g.string.isString;
		t.parse = function (e) {
			if (p = e, m = -1, h = "", !w(p))return null;
			s(), i();
			var r, n = f();
			if (n) {
			...
			if (w(e)) {
				...
				return r.value = this.value, r.fixPrefix = !0, r
			}
			if (e instanceof t) {
			...
			return this.format()
		}, t.prototype.valueOf = t.prototype.toString, t.prototype.format = function (e) {
			var r, n;
			if (null === this.value || this.fixPrefix)r = this._unnormalize(this.value), n = null !== this.value ? d.format(r, e) + " " : "", n += this.prefix.name + this.unit.name; else {
			...
			var e = Math.abs(this.value / this.unit.value), r = b, n = Math.abs(Math.log(e / r.value) / Math.LN10 - 1.2), t = this.unit.prefixes;
		...
		var v = {
			...
			ANGLE: {},
			BIT: {}
		}, N = {}, M = {name: "", base: N, value: 1, offset: 0}, T = {
			meter: {
				name: "meter",
				base: E.LENGTH,
				prefixes: v.LONG,
			...
			inch: {name: "inch", base: E.LENGTH, prefixes: v.NONE, value: .0254, offset: 0},
			foot: {name: "foot", base: E.LENGTH, prefixes: v.NONE, value: .3048, offset: 0},
			yard: {name: "yard", base: E.LENGTH, prefixes: v.NONE, value: .9144, offset: 0},
			mile: {name: "mile", base: E.LENGTH, prefixes: v.NONE, value: 1609.344, offset: 0},
			link: {name: "link", base: E.LENGTH, prefixes: v.NONE, value: .201168, offset: 0},
			rod: {name: "rod", base: E.LENGTH, prefixes: v.NONE, value: 5.02921, offset: 0},
			chain: {name: "chain", base: E.LENGTH, prefixes: v.NONE, value: 20.1168, offset: 0},
			angstrom: {name: "angstrom", base: E.LENGTH, prefixes: v.NONE, value: 1e-10, offset: 0},
			m: {name: "m", base: E.LENGTH, prefixes: v.SHORT, value: 1, offset: 0},
			"in": {name: "in", base: E.LENGTH, prefixes: v.NONE, value: .0254, offset: 0},
			ft: {name: "ft", base: E.LENGTH, prefixes: v.NONE, value: .3048, offset: 0},
			yd: {name: "yd", base: E.LENGTH, prefixes: v.NONE, value: .9144, offset: 0},
			mi: {name: "mi", base: E.LENGTH, prefixes: v.NONE, value: 1609.344, offset: 0},
			li: {name: "li", base: E.LENGTH, prefixes: v.NONE, value: .201168, offset: 0},
			rd: {name: "rd", base: E.LENGTH, prefixes: v.NONE, value: 5.02921, offset: 0},
			ch: {name: "ch", base: E.LENGTH, prefixes: v.NONE, value: 20.1168, offset: 0},
			mil: {name: "mil", base: E.LENGTH, prefixes: v.NONE, value: 254e-7, offset: 0},
			m2: {name: "m2", base: E.SURFACE, prefixes: v.SQUARED, value: 1, offset: 0},
			sqin: {name: "sqin", base: E.SURFACE, prefixes: v.NONE, value: 64516e-8, offset: 0},
			sqft: {name: "sqft", base: E.SURFACE, prefixes: v.NONE, value: .09290304, offset: 0},
			sqyd: {name: "sqyd", base: E.SURFACE, prefixes: v.NONE, value: .83612736, offset: 0},
			sqmi: {name: "sqmi", base: E.SURFACE, prefixes: v.NONE, value: 2589988.110336, offset: 0},
			sqrd: {name: "sqrd", base: E.SURFACE, prefixes: v.NONE, value: 25.29295, offset: 0},
			sqch: {name: "sqch", base: E.SURFACE, prefixes: v.NONE, value: 404.6873, offset: 0},
			sqmil: {name: "sqmil", base: E.SURFACE, prefixes: v.NONE, value: 6.4516e-10, offset: 0},
			m3: {name: "m3", base: E.VOLUME, prefixes: v.CUBIC, value: 1, offset: 0},
			L: {name: "L", base: E.VOLUME, prefixes: v.SHORT, value: .001, offset: 0},
			l: {name: "l", base: E.VOLUME, prefixes: v.SHORT, value: .001, offset: 0},
			litre: {name: "litre", base: E.VOLUME, prefixes: v.LONG, value: .001, offset: 0},
			cuin: {name: "cuin", base: E.VOLUME, prefixes: v.NONE, value: 16387064e-12, offset: 0},
			cuft: {name: "cuft", base: E.VOLUME, prefixes: v.NONE, value: .028316846592, offset: 0},
			cuyd: {name: "cuyd", base: E.VOLUME, prefixes: v.NONE, value: .764554857984, offset: 0},
			teaspoon: {name: "teaspoon", base: E.VOLUME, prefixes: v.NONE, value: 5e-6, offset: 0},
			tablespoon: {name: "tablespoon", base: E.VOLUME, prefixes: v.NONE, value: 15e-6, offset: 0},
			drop: {name: "drop", base: E.VOLUME, prefixes: v.NONE, value: 5e-8, offset: 0},
			gtt: {name: "gtt", base: E.VOLUME, prefixes: v.NONE, value: 5e-8, offset: 0},
			minim: {name: "minim", base: E.VOLUME, prefixes: v.NONE, value: 6.161152e-8, offset: 0},
			fluiddram: {name: "fluiddram", base: E.VOLUME, prefixes: v.NONE, value: 36966911e-13, offset: 0},
			fluidounce: {name: "fluidounce", base: E.VOLUME, prefixes: v.NONE, value: 2957353e-11, offset: 0},
			gill: {name: "gill", base: E.VOLUME, prefixes: v.NONE, value: .0001182941, offset: 0},
			cc: {name: "cc", base: E.VOLUME, prefixes: v.NONE, value: 1e-6, offset: 0},
			cup: {name: "cup", base: E.VOLUME, prefixes: v.NONE, value: .0002365882, offset: 0},
			pint: {name: "pint", base: E.VOLUME, prefixes: v.NONE, value: .0004731765, offset: 0},
			quart: {name: "quart", base: E.VOLUME, prefixes: v.NONE, value: .0009463529, offset: 0},
			gallon: {name: "gallon", base: E.VOLUME, prefixes: v.NONE, value: .003785412, offset: 0},
			beerbarrel: {name: "beerbarrel", base: E.VOLUME, prefixes: v.NONE, value: .1173478, offset: 0},
			oilbarrel: {name: "oilbarrel", base: E.VOLUME, prefixes: v.NONE, value: .1589873, offset: 0},
			hogshead: {name: "hogshead", base: E.VOLUME, prefixes: v.NONE, value: .238481, offset: 0},
			fldr: {name: "fldr", base: E.VOLUME, prefixes: v.NONE, value: 36966911e-13, offset: 0},
			floz: {name: "floz", base: E.VOLUME, prefixes: v.NONE, value: 2957353e-11, offset: 0},
			gi: {name: "gi", base: E.VOLUME, prefixes: v.NONE, value: .0001182941, offset: 0},
			cp: {name: "cp", base: E.VOLUME, prefixes: v.NONE, value: .0002365882, offset: 0},
			pt: {name: "pt", base: E.VOLUME, prefixes: v.NONE, value: .0004731765, offset: 0},
			qt: {name: "qt", base: E.VOLUME, prefixes: v.NONE, value: .0009463529, offset: 0},
			gal: {name: "gal", base: E.VOLUME, prefixes: v.NONE, value: .003785412, offset: 0},
			bbl: {name: "bbl", base: E.VOLUME, prefixes: v.NONE, value: .1173478, offset: 0},
			obl: {name: "obl", base: E.VOLUME, prefixes: v.NONE, value: .1589873, offset: 0},
			g: {name: "g", base: E.MASS, prefixes: v.SHORT, value: .001, offset: 0},
			gram: {name: "gram", base: E.MASS, prefixes: v.LONG, value: .001, offset: 0},
			ton: {name: "ton", base: E.MASS, prefixes: v.SHORT, value: 907.18474, offset: 0},
			tonne: {name: "tonne", base: E.MASS, prefixes: v.SHORT, value: 1e3, offset: 0},
			grain: {name: "grain", base: E.MASS, prefixes: v.NONE, value: 6479891e-11, offset: 0},
			dram: {name: "dram", base: E.MASS, prefixes: v.NONE, value: .0017718451953125, offset: 0},
			ounce: {name: "ounce", base: E.MASS, prefixes: v.NONE, value: .028349523125, offset: 0},
			poundmass: {name: "poundmass", base: E.MASS, prefixes: v.NONE, value: .45359237, offset: 0},
			hundredweight: {name: "hundredweight", base: E.MASS, prefixes: v.NONE, value: 45.359237, offset: 0},
			stick: {name: "stick", base: E.MASS, prefixes: v.NONE, value: .115, offset: 0},
			gr: {name: "gr", base: E.MASS, prefixes: v.NONE, value: 6479891e-11, offset: 0},
			dr: {name: "dr", base: E.MASS, prefixes: v.NONE, value: .0017718451953125, offset: 0},
			oz: {name: "oz", base: E.MASS, prefixes: v.NONE, value: .028349523125, offset: 0},
			lbm: {name: "lbm", base: E.MASS, prefixes: v.NONE, value: .45359237, offset: 0},
			cwt: {name: "cwt", base: E.MASS, prefixes: v.NONE, value: 45.359237, offset: 0},
			s: {name: "s", base: E.TIME, prefixes: v.SHORT, value: 1, offset: 0},
			min: {name: "min", base: E.TIME, prefixes: v.NONE, value: 60, offset: 0},
			h: {name: "h", base: E.TIME, prefixes: v.NONE, value: 3600, offset: 0},
			second: {name: "second", base: E.TIME, prefixes: v.LONG, value: 1, offset: 0},
			sec: {name: "sec", base: E.TIME, prefixes: v.LONG, value: 1, offset: 0},
			minute: {name: "minute", base: E.TIME, prefixes: v.NONE, value: 60, offset: 0},
			hour: {name: "hour", base: E.TIME, prefixes: v.NONE, value: 3600, offset: 0},
			day: {name: "day", base: E.TIME, prefixes: v.NONE, value: 86400, offset: 0},
			rad: {name: "rad", base: E.ANGLE, prefixes: v.NONE, value: 1, offset: 0},
			deg: {name: "deg", base: E.ANGLE, prefixes: v.NONE, value: .017453292519943295, offset: 0},
			grad: {name: "grad", base: E.ANGLE, prefixes: v.NONE, value: .015707963267948967, offset: 0},
			cycle: {name: "cycle", base: E.ANGLE, prefixes: v.NONE, value: 6.283185307179586, offset: 0},
			A: {name: "A", base: E.CURRENT, prefixes: v.SHORT, value: 1, offset: 0},
			ampere: {name: "ampere", base: E.CURRENT, prefixes: v.LONG, value: 1, offset: 0},
			K: {name: "K", base: E.TEMPERATURE, prefixes: v.NONE, value: 1, offset: 0},
			degC: {name: "degC", base: E.TEMPERATURE, prefixes: v.NONE, value: 1, offset: 273.15},
			degF: {name: "degF", base: E.TEMPERATURE, prefixes: v.NONE, value: 1 / 1.8, offset: 459.67},
			degR: {name: "degR", base: E.TEMPERATURE, prefixes: v.NONE, value: 1 / 1.8, offset: 0},
			kelvin: {name: "kelvin", base: E.TEMPERATURE, prefixes: v.NONE, value: 1, offset: 0},
			celsius: {name: "celsius", base: E.TEMPERATURE, prefixes: v.NONE, value: 1, offset: 273.15},
			fahrenheit: {name: "fahrenheit", base: E.TEMPERATURE, prefixes: v.NONE, value: 1 / 1.8, offset: 459.67},
			rankine: {name: "rankine", base: E.TEMPERATURE, prefixes: v.NONE, value: 1 / 1.8, offset: 0},
			mol: {name: "mol", base: E.AMOUNT_OF_SUBSTANCE, prefixes: v.NONE, value: 1, offset: 0},
			mole: {name: "mole", base: E.AMOUNT_OF_SUBSTANCE, prefixes: v.NONE, value: 1, offset: 0},
			cd: {name: "cd", base: E.LUMINOUS_INTENSITY, prefixes: v.NONE, value: 1, offset: 0},
			candela: {name: "candela", base: E.LUMINOUS_INTENSITY, prefixes: v.NONE, value: 1, offset: 0},
			N: {name: "N", base: E.FORCE, prefixes: v.SHORT, value: 1, offset: 0},
			newton: {name: "newton", base: E.FORCE, prefixes: v.LONG, value: 1, offset: 0},
			lbf: {name: "lbf", base: E.FORCE, prefixes: v.NONE, value: 4.4482216152605, offset: 0},
			poundforce: {name: "poundforce", base: E.FORCE, prefixes: v.NONE, value: 4.4482216152605, offset: 0},
			b: {name: "b", base: E.BIT, prefixes: v.BINARY_SHORT, value: 1, offset: 0},
			bits: {name: "bits", base: E.BIT, prefixes: v.BINARY_LONG, value: 1, offset: 0},
			B: {name: "B", base: E.BIT, prefixes: v.BINARY_SHORT, value: 8, offset: 0},
			bytes: {name: "bytes", base: E.BIT, prefixes: v.BINARY_LONG, value: 8, offset: 0}
		}, A = {
			meters: "meter",
			inches: "inch",
			feet: "foot",
		...
		for (var S in A)if (A.hasOwnProperty(S)) {
			var O = T[A[S]], C = Object.create(O);
			C.name = S, T[S] = C
		}
		T.lt = T.l, T.liter = T.litre, T.liters = T.litres, T.lb = T.lbm, T.lbs = T.lbm, t.PREFIXES = v, t.BASE_UNITS = E, t.UNITS = T, e.exports = t
	}, function (e, r, n) {
		"use strict";
		function t(e, r) {
			if (!(this instanceof t))throw new SyntaxError("Constructor must be called with the new operator");
		...
		var i = n(144), o = i.object, a = i.string;
		t.isHelp = function (e) {
			return e instanceof t
		}, t.prototype.toString = function () {
			var e = this.doc || {}, r = "\n";
		...
		function t(e, r, n) {
			...
			if (0 >= r) {
				if (c(e[0])) {
					for (u = i(e), a = [], o = 0; o < u.length; o++)a[o] = t(u[o], r - 1, n);
					return a
				}
		...
		function i(e) {
			var r, n, t = e.length, i = e[0].length, o = [];
			for (n = 0; i > n; n++) {
				var a = [];
		...
		{
			var o = n(144), a = n(142), s = n(141), u = n(9), f = o.array, c = o.array.isArray;
			o.string.isString
		}
		r.argsToArray = function (e) {
			...
			if (1 == e.length) {
				var r = e[0];
				return r instanceof u && (r = r.valueOf()), c(r) || (r = [r]), r
			}
			return o.array.argsToArray(e)
		}, r.isCollection = function (e) {
			return c(e) || e instanceof u
		}, r.deepMap = function l(e, r) {
			return e && "function" == typeof e.map ? e.map(function (e) {
				return l(e, r)
			}) : r(e)
		}, r.deepMap2 = function p(e, r, n) {
			var t, i, o;
			if (c(e))if (c(r)) {
				if (e.length != r.length)throw new s(e.length, r.length);
				for (t = [], i = e.length, o = 0; i > o; o++)t[o] = p(e[o], r[o], n)
			} else {
				if (r instanceof u)return t = p(e, r.valueOf(), n), new u(t);
				for (t = [], i = e.length, o = 0; i > o; o++)t[o] = p(e[o], r, n)
			} else {
				if (e instanceof u)return r instanceof u ? (t = p(e.valueOf(), r.valueOf(), n), new u(t)) : (t = p(e.valueOf(), r, n), new u(t));
				if (c(r))for (t = [], i = r.length, o = 0; i > o; o++)t[o] = p(e, r[o], n); else {
					if (r instanceof u)return t = p(e, r.valueOf(), n), new u(t);
					t = n(e, r)
				}
			}
			...
			var i = c(e) ? f.size(e) : e.size();
			if (0 > r)throw new a(r);
			if (r >= i.length)throw new a(r, i.length);
			return e instanceof u ? new u(t(e.valueOf(), r, n)) : t(e, r, n)
		}, r.deepForEach = function m(e, r) {
		...
		function t(e, r) {
			...
			if (sr = r && r.nodes ? r.nodes : {}, D(e))return ur = e, h();
			if (G(e) || e instanceof V)return H.deepMap(e, function (e) {
		...
		function i() {
			fr = 0, cr = ur.charAt(0), mr = 0, hr = null
		}
		...
		function a() {
			return ur.charAt(fr + 1)
		}

		function s() {
			for (pr = ir.NULL, lr = ""; " " == cr || "	" == cr || "\n" == cr && mr;)o();
			if ("#" == cr)for (; "\n" != cr && "" != cr;)o();
			if ("" == cr)return void(pr = ir.DELIMITER);
			if ("\n" == cr && !mr)return pr = ir.DELIMITER, lr = cr, void o();
			var e = cr + a();
			if (2 == e.length && or[e])return pr = ir.DELIMITER, lr = e, o(), void o();
			if (or[cr])return pr = ir.DELIMITER, lr = cr, void o();
			if (!p(cr)) {
				if (l(cr)) {
					for (; l(cr) || m(cr);)lr += cr, o();
					return void(pr = ar[lr] ? ir.DELIMITER : ir.SYMBOL)
				}
				for (pr = ir.UNKNOWN; "" != cr;)lr += cr, o();
				throw P('Syntax error in part "' + lr + '"')
			}
			if (pr = ir.NUMBER, "." == cr)lr += cr, o(), m(cr) || (pr = ir.UNKNOWN); else {
				for (; m(cr);)lr += cr, o();
				"." == cr && (lr += cr, o())
			}
			for (; m(cr);)lr += cr, o();
			if ("E" == cr || "e" == cr)for (lr += cr, o(), ("+" == cr || "-" == cr) && (lr += cr, o()), m(cr) || (pr = ir.UNKNOWN); m(cr);)lr += cr, o()
		}
		...
		function h() {
			i(), s();
			var e = g();
			if ("" != lr)throw pr == ir.DELIMITER ? k("Unexpected operator " + lr) : P('Unexpected part "' + lr + '"');
			return e
		}

		function g() {
			var e, r, n;
			if ("" == lr)return new K("undefined", "undefined");
			for ("\n" != lr && ";" != lr && (e = d()); "\n" == lr || ";" == lr;)r || (r = new W, e && (n = ";" != lr, r.add(e, n))), s(), "\n" != lr && ";" != lr && "" != lr && (e = d(), n = ";" != lr, r.add(e, n));
			return r ? r : e
		}

		function d() {
			if (pr == ir.SYMBOL && "function" == lr)throw P('Deprecated keyword "function". Functions can now be assigned without it, like "f(x) = x^2".');
			return x()
		}
		...
		function x() {
			var e, r, n, t, i = y();
			if ("=" == lr) {
				if (i instanceof nr)return e = i.name, u(), n = x(), new Z(e, n);
				if (i instanceof J)return u(), n = x(), new tr(i, n);
				if (i instanceof er && (t = !0, r = [], e = i.symbol.name, i.params.forEach(function (e, n) {
						e instanceof nr ? r[n] = e.name : t = !1
					}), t))return u(), n = x(), new $(e, r, n);
		...
		function y() {
			for (var e = w(); "?" == lr;) {
				...
				hr = mr, u();
				var n = e, t = w();
				if (":" != lr)throw P("False part of conditional expression expected");
				hr = null, u();
				var i = y();
				e = new Q(n, t, i), hr = r
			}
		...
		function w() {
			...
			for (e = v(), r = {
				...
				"<=": "smallerEq",
				">=": "largerEq"
			}; lr in r;)n = lr, t = r[n], u(), i = [e, v()], e = new X(n, t, i);
			return e
		}

		function v() {
			var e, r, n, t, i;
			for (e = b(), r = {to: "to", "in": "to"}; lr in r;)n = lr, t = r[n], u(), i = [e, b()], e = new X(n, t, i);
			return e
		}

		function b() {
			var e, r = [];
			if (e = ":" == lr ? new K("1", "number") : E(), ":" == lr && hr !== mr) {
				for (r.push(e); ":" == lr;)u(), r.push(")" == lr || "]" == lr || "," == lr || "" == lr ? new nr("end") : E());
				if (3 == r.length) {
					var n = r[2];
					r[2] = r[1], r[1] = n
				}
		...
		function E() {
			var e, r, n, t, i;
			for (e = N(), r = {"+": "add", "-": "subtract"}; lr in r;)n = lr, t = r[n], u(), i = [e, N()], e = new X(n, t, i);
			return e
		}
		...
		function N() {
			...
			if (e = M(), r = {
					...
					"%": "mod",
					mod: "mod"
				}, lr in r)for (; lr in r;)n = lr, t = r[n], u(), i = [e, M()], e = new X(n, t, i);
			return (pr == ir.SYMBOL || "in" == lr && e instanceof K || pr == ir.NUMBER && !(e instanceof K) || "(" == lr || "[" == lr) && (e = new X("*", "multiply", [e, N()])), e
		}

		function M() {
			var e, r, n;
			return "-" == lr || "+" == lr ? (e = lr, r = "+" == e ? "unaryPlus" : "unaryMinus", u(), n = [M()], new X(e, r, n)) : T()
		}

		function T() {
			var e, r, n, t;
			return e = A(), ("^" == lr || ".^" == lr) && (r = lr, n = "^" == r ? "pow" : "dotPow", u(), t = [e, M()], e = new X(r, n, t)), e
		}
		...
		function A() {
			...
			for (e = S(), r = {
				"!": "factorial",
				"'": "transpose"
			}; lr in r;)n = lr, t = r[n], s(), i = [e], e = new X(n, t, i);
			return e
		}

		function S() {
			var e, r = [];
			if (pr == ir.SYMBOL && sr[lr]) {
				if (e = sr[lr], s(), "(" == lr) {
					if (r = [], f(), s(), ")" != lr)for (r.push(y()); "," == lr;)s(), r.push(y());
					if (")" != lr)throw P("Parenthesis ) expected");
					c(), s()
				}
				return new e(r)
			}
		...
		function O() {
			var e, r;
			return pr == ir.SYMBOL || pr == ir.DELIMITER && lr in ar ? (r = lr, s(), e = new nr(r), e = C(e), e = U(e)) : q()
		}
		...
		function q() {
			var e, r, n;
			if ('"' == lr) {
				for (r = "", n = ""; "" != cr && ('"' != cr || "\\" == n);)r += cr, n = cr, o();
				if (s(), '"' != lr)throw P('End of string " expected');
				return s(), e = new K(r, "string"), e = U(e)
			}
			return B()
		}
		...
		function B() {
			...
			if ("[" == lr) {
				if (f(), s(), "]" != lr) {
					var i = z();
					if (";" == lr) {
						for (n = 1, r = [i]; ";" == lr;)s(), r[n] = z(), n++;
						if ("]" != lr)throw P("End of matrix ] expected");
						c(), s(), t = r[0].nodes.length;
						for (var o = 1; n > o; o++)if (r[o].nodes.length != t)throw k("Column dimensions mismatch (" + r[o].nodes.length + " != " + t + ")");
						e = new Y(r)
					} else {
						if ("]" != lr)throw P("End of matrix ] expected");
						c(), s(), e = i
		...
		function z() {
			for (var e = [x()], r = 1; "," == lr;)s(), e[r] = x(), r++;
			return new Y(e)
		}

		function I() {
			var e;
			return pr == ir.NUMBER ? (e = lr, s(), new K(e, "number")) : _()
		}

		function _() {
			var e;
			if ("(" == lr) {
				if (f(), s(), e = x(), ")" != lr)throw P("Parenthesis ) expected");
				return c(), s(), e
			}
			return R()
		}
		...
		function R() {
			throw P("" == lr ? "Unexpected end of expression" : "Value expected")
		}

		function L() {
			return fr - lr.length + 1
		}

		function P(e) {
			var r = L(), n = new SyntaxError(e + " (char " + r + ")");
			return n["char"] = r, n
		}

		function k(e) {
			var r = L(), n = new Error(e + " (char " + r + ")");
			return n["char"] = r, n
		}

		var j = n(144), F = n(140), D = j.string.isString, G = Array.isArray, V = (j.types.type, n(6), n(9)), H = (n(10), n(13)), Y = n(145), Z = n(146), W = n(147), Q = n(148), K = n(149), $ = n(150), J = n(151), X = n(152), er = n(153), rr = n(154), nr = n(155), tr = n(156), ir = {
			NULL: 0,
			DELIMITER: 1,
			NUMBER: 2,
			SYMBOL: 3,
			...
			"<=": !0,
			">=": !0
		}, ar = {mod: !0, to: !0, "in": !0}, sr = {}, ur = "", fr = 0, cr = "", lr = "", pr = ir.NULL, mr = 0, hr = null;
		e.exports = t
	}, function (e, r, n) {
		"use strict";
		function t(e) {
			if (!(this instanceof t))throw new SyntaxError("Constructor must be called with the new operator");
			if (!(e instanceof Object))throw new TypeError("Object expected as parameter math");
		...
		"use strict";
		var t = n(155), i = (n(159).isBoolean, n(137).argsToArray, n(140));
		e.exports = function (e) {
			var r = e.filter;
			r.transform = function (e, n, o) {
				if (2 !== e.length)throw new i("filter", arguments.length, 2);
				var a, s = e[0].compile(n).eval(o);
				if (e[1]instanceof t)a = e[1].compile(n).eval(o); else {
					var u = o || {}, f = e[1].find({type: t}).filter(function (e) {
						return !(e.name in n || e.name in u)
					})[0], c = Object.create(u), l = e[1].compile(n);
					if (!f)throw new Error("No undefined variable found in filter equation");
					var p = f.name;
					a = function (e) {
						return c[p] = e, l.eval(c)
					}
				}
				return r(s, a)
			}, e.filter.transform.rawArgs = !0
		}
	}, function (e, r, n) {
		"use strict";
		{
			var t = n(9);
			n(139), n(7), n(8), n(4).isNumber, Array.isArray
		}
		e.exports = function (e) {
			e.forEach.transform = function (r, n) {
				if (2 != arguments.length)throw new e.error.ArgumentsError("forEach", arguments.length, 2);
				var i = r instanceof t ? r.valueOf() : r;
				if (!Array.isArray(i))throw new e.error.UnsupportedTypeError("forEach", e["typeof"](r));
				var o = [], a = function (e, t) {
					return Array.isArray(e) ? e.map(function (e, r) {
						return o[t] = r + 1, a(e, t + 1)
					}) : void n(e, o, r)
				};
				a(i, 0)
			}
		...
		"use strict";
		{
			var t = n(139), i = n(7), o = n(8), a = (n(9), n(4).isNumber);
			Array.isArray
		}
		e.exports = function (e) {
			e.index.transform = function () {
				for (var e = [], r = 0, n = arguments.length; n > r; r++) {
					var s = arguments[r];
					if (s instanceof i)s.start--, s.end -= s.step > 0 ? 0 : 2; else if (a(s))s--; else {
						if (!(s instanceof t))throw new TypeError("Ranges must be a Number or Range");
						s = s.toNumber() - 1
					}
					e[r] = s
				}
		...
		e.exports = function (e) {
			e.map.transform = function (r, n) {
				if (2 != arguments.length)throw new e.error.ArgumentsError("map", arguments.length, 2);
				var i = r instanceof t, o = i ? r.valueOf() : r;
				if (Array.isArray(o)) {
					var a = [], s = function (e, t) {
						return Array.isArray(e) ? e.map(function (e, r) {
							return a[t] = r + 1, s(e, t + 1)
						}) : n(e, a, r)
					}, u = s(o, 0);
					return i ? new t(u) : u
				}
				throw new e.error.UnsupportedTypeError("map", e["typeof"](r))
			}
		}
	}, function (e, r, n) {
		"use strict";
		var t = n(139), i = n(158).transform, o = n(4).isNumber, a = n(13).isCollection, s = n(137).argsToArray;
		e.exports = function (e) {
			e.max.transform = function () {
				var r = s(arguments);
				if (2 == r.length && a(r[0])) {
					var n = r[1];
					o(n) ? r[1] = n - 1 : n instanceof t && (r[1] = n.minus(1))
				}
				try {
					return e.max.apply(e, r)
				} catch (u) {
					throw i(u)
				}
			}
		...
		"use strict";
		var t = n(159).isBoolean, i = n(137).argsToArray;
		e.exports = function (e) {
			e.range.transform = function () {
				var r = i(arguments), n = r.length - 1, o = r[n];
				return t(o) || r.push(!0), e.range.apply(e, r)
			}
		}
	}, function (e, r, n) {
		"use strict";
		var t = n(158).transform, i = (n(159).isBoolean, n(137).argsToArray);
		e.exports = function (e) {
			e.subset.transform = function () {
				try {
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = n(14), i = n(13), o = r.string.isString, a = i.isCollection;
		...
		e.exports = function (e) {
			...
			e.help = function (n) {
				...
				var t = null;
				if (n instanceof String || "string" == typeof n)t = n; else {
					var i;
					for (i in e)if (e.hasOwnProperty(i) && n === e[i]) {
						t = i;
						break
					}
				}
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = (n(9), n(13)), a = r.number.isNumber, s = r["boolean"].isBoolean, u = i.isComplex, f = o.isCollection;
			e.abs = function c(r) {
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = (n(9), n(10)), a = n(13), s = r["boolean"].isBoolean, u = r.number.isNumber, f = r.string.isString, c = i.isComplex, l = o.isUnit, p = a.isCollection;
			e.add = function m(r, n) {
				...
				if (r instanceof t)return u(n) ? n = t.convert(n) : (s(n) || null === n) && (n = new t(n ? 1 : 0)), n instanceof t ? r.plus(n) : m(r.toNumber(), n);
				if (n instanceof t)return u(r) ? r = t.convert(r) : (s(r) || null === r) && (r = new t(r ? 1 : 0)), r instanceof t ? r.plus(n) : m(r, n.toNumber());
				if (p(r) || p(n))return a.deepMap2(r, n, m);
				if (f(r) || f(n))return r + n;
				if (s(r) || null === r)return m(+r, n);
				if (s(n) || null === n)return m(r, +n);
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = n(13), a = r.number.isNumber, s = r["boolean"].isBoolean, u = o.isCollection, f = i.isComplex;
			e.ceil = function c(r) {
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = n(13), a = r.number.isNumber, s = r["boolean"].isBoolean, u = i.isComplex, f = o.isCollection;
			e.cube = function c(r) {
		...
		e.exports = function (e) {
			...
			var t = n(144), i = e.type.BigNumber, o = n(6), a = (n(9), n(10)), s = n(13), u = t.number.isNumber, f = t["boolean"].isBoolean, c = o.isComplex, l = a.isUnit, p = s.isCollection;
			e.divide = function m(n, t) {
				...
				if (n instanceof i)return u(t) ? t = i.convert(t) : (f(t) || null === t) && (t = new i(t ? 1 : 0)), t instanceof i ? n.div(t) : m(n.toNumber(), t);
				if (t instanceof i)return u(n) ? n = i.convert(n) : (f(n) || null === n) && (n = new i(n ? 1 : 0)), n instanceof i ? n.div(t) : m(n, t.toNumber());
				if (l(n) && u(t)) {
					var a = n.clone();
					return a.value /= t, a
				}
		...
		e.exports = function (e) {
			...
			var t = n(144), i = e.type.BigNumber, o = n(13), a = t.number.isNumber, s = t["boolean"].isBoolean, u = t.number.isInteger, f = o.isCollection;
			e.gcd = function c() {
				var n, t = arguments[0], l = arguments[1];
				if (2 == arguments.length) {
					if (a(t) && a(l)) {
						if (!u(t) || !u(l))throw new Error("Parameters in function gcd must be integer numbers");
						for (; 0 != l;)n = t % l, t = l, l = n;
						return 0 > t ? -t : t
					}
					if (f(t) || f(l))return o.deepMap2(t, l, c);
					if (t instanceof i)return a(l) ? l = i.convert(l) : (s(l) || null === l) && (l = new i(l ? 1 : 0)), l instanceof i ? r(t, l) : c(t.toNumber(), l);
					if (l instanceof i)return a(t) ? t = i.convert(t) : (s(t) || null === t) && (t = new i(t ? 1 : 0)), t instanceof i ? r(t, l) : c(t.toNumber(), l);
					if (s(t) || null === t)return c(+t, l);
					if (s(l) || null === l)return c(t, +l);
					throw new e.error.UnsupportedTypeError("gcd", e["typeof"](t), e["typeof"](l))
				}
				if (arguments.length > 2) {
					for (var p = 1; p < arguments.length; p++)t = c(t, arguments[p]);
					return t
				}
		...
		e.exports = function (e) {
			...
			e.lcm = function c() {
				...
				if (2 == arguments.length) {
					if (a(t) && a(l)) {
						if (!u(t) || !u(l))throw new Error("Parameters in function lcm must be integer numbers");
						if (0 == t || 0 == l)return 0;
						for (var p = t * l; 0 != l;)n = l, l = t % n, t = n;
						return Math.abs(p / t)
					}
					if (f(t) || f(l))return o.deepMap2(t, l, c);
					if (t instanceof i)return a(l) ? l = i.convert(l) : (s(l) || null === l) && (l = new i(l ? 1 : 0)), l instanceof i ? r(t, l) : c(t.toNumber(), l);
					...
					if (s(t) || null === t)return c(+t, l);
					if (s(l) || null === l)return c(t, +l);
					throw new e.error.UnsupportedTypeError("lcm", e["typeof"](t), e["typeof"](l))
				}
				if (arguments.length > 2) {
					for (var m = 1; m < arguments.length; m++)t = c(t, arguments[m]);
					return t
				}
		...
		e.exports = function (e) {
			...
			var t = n(144), i = e.type.BigNumber, o = n(13), a = t.number.isNumber, s = t["boolean"].isBoolean, u = o.isCollection;
			e.mod = function f(n, t) {
				if (2 != arguments.length)throw new e.error.ArgumentsError("mod", arguments.length, 2);
				if (a(n) && a(t))return r(n, t);
				if (n instanceof i)return a(t) ? t = i.convert(t) : (s(t) || null === t) && (t = new i(t ? 1 : 0)), t instanceof i ? t.isZero() ? n : n.mod(t) : f(n.toNumber(), t);
				if (t instanceof i)return a(n) ? n = i.convert(n) : (s(n) || null === n) && (n = new i(n ? 1 : 0)), n instanceof i ? t.isZero() ? n : n.mod(t) : f(n, t.toNumber());
				if (u(n) || u(t))return o.deepMap2(n, t, f);
				if (s(n) || null === n)return f(+n, t);
		...
		e.exports = function (e) {
			...
			var s = n(144), u = e.type.BigNumber, f = n(6), c = n(9), l = n(10), p = n(13), m = s.array, h = s.number.isNumber, g = s["boolean"].isBoolean, d = f.isComplex, x = Array.isArray, y = l.isUnit;
			e.multiply = function w(n, s) {
				var l;
				if (2 != arguments.length)throw new e.error.ArgumentsError("multiply", arguments.length, 2);
				if (h(n)) {
					if (h(s))return n * s;
					if (d(s))return a(new f(n, 0), s);
					if (y(s))return l = s.clone(), l.value = null === l.value ? l._normalize(n) : l.value * n, l
				}
				if (d(n)) {
					if (h(s))return a(n, new f(s, 0));
					if (d(s))return a(n, s)
				}
				if (n instanceof u)return h(s) ? s = u.convert(s) : (g(s) || null === s) && (s = new u(s ? 1 : 0)), s instanceof u ? n.times(s) : w(n.toNumber(), s);
				if (s instanceof u)return h(n) ? n = u.convert(n) : (g(n) || null === n) && (n = new u(n ? 1 : 0)), n instanceof u ? n.times(s) : w(n, s.toNumber());
				if (y(n) && h(s))return l = n.clone(), l.value = null === l.value ? l._normalize(s) : l.value * s, l;
				if (x(n)) {
					if (x(s)) {
						var v = m.size(n), b = m.size(s);
						if (1 == v.length) {
							if (1 == b.length) {
					...
					return s instanceof c ? (l = w(n, s.valueOf()), x(l) ? new c(l) : l) : p.deepMap2(n, s, w)
				}
				if (n instanceof c)return s instanceof c ? (l = w(n.valueOf(), s.valueOf()), x(l) ? new c(l) : l) : (l = w(n.valueOf(), s), x(l) ? new c(l) : l);
				if (x(s))return p.deepMap2(n, s, w);
				if (s instanceof c)return new c(p.deepMap2(n, s.valueOf(), w));
				if (g(n) || null === n)return w(+n, s);
				if (g(s) || null === s)return w(n, +s);
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = n(137), i = e.type.BigNumber, o = n(6), a = n(9), s = (n(13), r.number.isNumber), u = r["boolean"].isBoolean, f = o.isComplex, c = Array.isArray;
			e.norm = function l(r, n) {
				...
				if (f(r))return Math.sqrt(r.re * r.re + r.im * r.im);
				if (r instanceof i)return r.abs();
				if (u(r) || null === r)return Math.abs(r);
				if (c(r)) {
					var o = t.size(r);
					...
					if (2 == o.length) {
						if (1 == n) {
							for (var m = [], h = 0; h < r.length; h++)for (var g = r[h], d = 0; d < g.length; d++)m[d] = e.add(m[d] || 0, e.abs(g[d]));
							return e.max(m)
						}
						if (n == Number.POSITIVE_INFINITY || "inf" === n) {
							for (var p = 0, h = 0; h < r.length; h++) {
								for (var x = 0, g = r[h], d = 0; d < g.length; d++)x = e.add(x, e.abs(g[d]));
								e.larger(x, p) && (p = x)
							}
							return p
						}
						if ("fro" === n) {
							var y = e.diag(e.multiply(e.transpose(r), r)), w = 0;
		...
		e.exports = function (e) {
			function r(r, n) {
				var t = e.log(r), i = e.multiply(t, n);
				return e.exp(i)
			}

			var t = n(144), i = e.type.BigNumber, o = n(6), a = n(9), s = (n(13), t.array), u = t.number.isNumber, f = t["boolean"].isBoolean, c = Array.isArray, l = t.number.isInteger, p = o.isComplex;
			e.pow = function m(n, t) {
				...
				if (n instanceof i)return u(t) ? t = i.convert(t) : (f(t) || null === t) && (t = new i(t ? 1 : 0)), t instanceof i ? t.isInteger() && !n.isNegative() ? n.pow(t) : m(n.toNumber(), t.toNumber()) : m(n.toNumber(), t);
				if (t instanceof i)return u(n) ? n = i.convert(n) : (f(n) || null === n) && (n = new i(n ? 1 : 0)), n instanceof i ? t.isInteger() && !n.isNegative() ? n.pow(t) : m(n.toNumber(), t.toNumber()) : m(n, t.toNumber());
				if (c(n)) {
		...
		e.exports = function (e) {
			...
			var t = n(144), i = e.type.BigNumber, o = n(6), a = n(13), s = t.number.isNumber, u = t.number.isInteger, f = t["boolean"].isBoolean, c = o.isComplex, l = a.isCollection;
			e.round = function p(n, t) {
				...
				if (void 0 == t) {
					...
					if (f(n) || null === n)return Math.round(n);
					throw new e.error.UnsupportedTypeError("round", e["typeof"](n))
				}
				if (!s(t) || !u(t)) {
					if (!(t instanceof i)) {
						if (f(t) || null === n)return p(n, +t);
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = n(13), a = r.number, s = r.number.isNumber, u = r["boolean"].isBoolean, f = i.isComplex, c = o.isCollection;
			e.sign = function l(r) {
		...
		e.exports = function (e) {
			...
			e.sqrt = function c(r) {
				...
				if (u(r)) {
					var n, l, p = Math.sqrt(r.re * r.re + r.im * r.im);
					return n = r.re >= 0 ? .5 * Math.sqrt(2 * (p + r.re)) : Math.abs(r.im) / Math.sqrt(2 * (p - r.re)), l = r.re <= 0 ? .5 * Math.sqrt(2 * (p - r.re)) : Math.abs(r.im) / Math.sqrt(2 * (p + r.re)), r.im >= 0 ? new i(n, l) : new i(n, -l)
				}
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = (n(9), n(10)), a = n(13), s = r["boolean"].isBoolean, u = r.number.isNumber, f = i.isComplex, c = o.isUnit, l = a.isCollection;
			e.subtract = function p(r, n) {
				...
				if (r instanceof t)return u(n) ? n = t.convert(n) : (s(n) || null === n) && (n = new t(n ? 1 : 0)), n instanceof t ? r.minus(n) : p(r.toNumber(), n);
				if (n instanceof t)return u(r) ? r = t.convert(r) : (s(r) || null === r) && (r = new t(r ? 1 : 0)), r instanceof t ? r.minus(n) : p(r, n.toNumber());
				if (c(r) && c(n)) {
					if (null == r.value)throw new Error("Parameter x contains a unit with undefined value");
					if (null == n.value)throw new Error("Parameter y contains a unit with undefined value");
					if (!r.equalBase(n))throw new Error("Units do not match");
				...
				if (s(r) || null === r)return p(+r, n);
				if (s(n) || null === n)return p(r, +n);
		...
		"use strict";
		e.exports = function (e, r) {
			var t = n(144), i = e.type.BigNumber, o = n(6), a = n(10), s = n(13), u = t.number.isNumber, f = t["boolean"].isBoolean, c = t.string.isString, l = o.isComplex, p = a.isUnit, m = s.isCollection;
			e.unaryMinus = function h(n) {
				if (1 != arguments.length)throw new e.error.ArgumentsError("unaryMinus", arguments.length, 1);
				if (u(n))return -n;
				if (l(n))return new o(-n.re, -n.im);
				if (n instanceof i)return n.neg();
				if (p(n)) {
					var t = n.clone();
					return t.value = -n.value, t
				}
				if (m(n))return s.deepMap(n, h);
				if (f(n) || c(n) || null === n)return "bignumber" == r.number ? new i(-n) : -n;
				throw new e.error.UnsupportedTypeError("unaryMinus", e["typeof"](n))
			}, e.unary = function () {
		...
		e.exports = function (e, r) {
			...
			e.unaryPlus = function h(n) {
				...
				if (m(n))return s.deepMap(n, h);
				if (f(n) || c(n) || null === n)return "bignumber" == r.number ? new i(+n) : +n;
				throw new e.error.UnsupportedTypeError("unaryPlus", e["typeof"](n))
			}
		}
	}, function (e, r, n) {
		"use strict";
		e.exports = function (e, r) {
			function t(e, n) {
				for (var t, i, o, s = 0, u = 1, f = 1, c = 0; n;)i = Math.floor(e / n), o = e % n, t = s, s = u - i * s, u = t, t = f, f = c - i * f, c = t, e = n, n = o;
				var l;
				return l = 0 > e ? [-e, -u, -c] : [e, e ? u : 0, c], "array" === r.matrix ? l : new a(l)
			}

			function i(e, n) {
				for (var t, i, o, u = new s(0), f = new s(0), c = new s(1), l = new s(1), p = new s(0); !n.isZero();)i = e.div(n).floor(), o = e.mod(n), t = f, f = c.minus(i.times(f)), c = t, t = l, l = p.minus(i.times(l)), p = t, e = n, n = o;
				var m;
				return m = e.lt(u) ? [e.neg(), c.neg(), p.neg()] : [e, e.isZero() ? 0 : c, p], "array" === r.matrix ? m : new a(m)
			}

			var o = n(144), a = n(9), s = e.type.BigNumber, u = o.number.isNumber, f = o["boolean"].isBoolean, c = o.number.isInteger;
			e.xgcd = function l(r, n) {
				if (2 == arguments.length) {
					if (u(r) && u(n)) {
						if (!c(r) || !c(n))throw new Error("Parameters in function xgcd must be integer numbers");
						return t(r, n)
					}
					if (r instanceof s)return u(n) ? n = s.convert(n) : (f(n) || null === n) && (n = new s(n ? 1 : 0)), n instanceof s ? i(r, n) : l(r.toNumber(), n);
					if (n instanceof s)return u(r) ? r = s.convert(r) : (f(r) || null === r) && (r = new s(r ? 1 : 0)), r instanceof s ? i(r, n) : l(r.toNumber(), n);
					if (f(r) || null === r)return l(+r, n);
					if (f(n) || null === n)return l(r, +n);
					throw new e.error.UnsupportedTypeError("xgcd", e["typeof"](r), e["typeof"](n))
				}
		...
		"use strict";
		e.exports = function (e, r) {
			var t = n(144), i = e.type.BigNumber, o = n(6), a = n(10), s = n(13), u = t.number.isNumber, f = t.number.nearlyEqual, c = t["boolean"].isBoolean, l = t.string.isString, p = o.isComplex, m = a.isUnit, h = s.isCollection;
			e.compare = function g(n, t) {
				...
				if (n instanceof i)return u(t) ? t = i.convert(t) : (c(t) || null === t) && (t = new i(t ? 1 : 0)), t instanceof i ? new i(n.cmp(t)) : g(n.toNumber(), t);
				if (t instanceof i)return u(n) ? n = i.convert(n) : (c(n) || null === n) && (n = new i(n ? 1 : 0)), n instanceof i ? new i(n.cmp(t)) : g(n, t.toNumber());
				if (m(n) && m(t)) {
			...
			function r(n, t) {
				if (o(n)) {
					if (o(t)) {
						...
						for (var a = 0; i > a; a++)if (!r(n[a], t[a]))return !1;
						return !0
					}
					return !1
				}
				return o(t) ? !1 : e.equal(n, t)
			}

			var t = n(13), i = t.isCollection, o = Array.isArray;
			e.deepEqual = function (n, t) {
				if (2 != arguments.length)throw new e.error.ArgumentsError("deepEqual", arguments.length, 2);
				return i(n) || i(t) ? r(n.valueOf(), t.valueOf()) : e.equal(n, t)
			}
		}
	}, function (e, r, n) {
		"use strict";
		...
		e.exports = function (e, r) {
			...
			e.larger = function g(n, t) {
				...
				if (n instanceof i)return u(t) ? t = i.convert(t) : (c(t) || null === t) && (t = new i(t ? 1 : 0)), t instanceof i ? n.gt(t) : g(n.toNumber(), t);
				if (t instanceof i)return u(n) ? n = i.convert(n) : (c(n) || null === n) && (n = new i(n ? 1 : 0)), n instanceof i ? n.gt(t) : g(n, t.toNumber());
				if (m(n) && m(t)) {
					if (!n.equalBase(t))throw new Error("Cannot compare units with different base");
					return n.value > t.value
				}
		...
		e.exports = function (e, r) {
			...
			e.largerEq = function g(n, t) {
				...
				if (u(n) && u(t))return f(n, t, r.epsilon) || n > t;
				if (n instanceof i)return u(t) ? t = i.convert(t) : (c(t) || null === t) && (t = new i(t ? 1 : 0)), t instanceof i ? n.gte(t) : g(n.toNumber(), t);
				if (t instanceof i)return u(n) ? n = i.convert(n) : (c(n) || null === n) && (n = new i(n ? 1 : 0)), n instanceof i ? n.gte(t) : g(n, t.toNumber());
				if (m(n) && m(t)) {
					if (!n.equalBase(t))throw new Error("Cannot compare units with different base");
					return n.value >= t.value
				}
		...
		e.exports = function (e, r) {
			...
			e.smaller = function g(n, t) {
				...
				if (n instanceof i)return u(t) ? t = i.convert(t) : (c(t) || null === t) && (t = new i(t ? 1 : 0)), t instanceof i ? n.lt(t) : g(n.toNumber(), t);
				if (t instanceof i)return u(n) ? n = i.convert(n) : (c(n) || null === n) && (n = new i(n ? 1 : 0)), n instanceof i ? n.lt(t) : g(n, t.toNumber());
				if (m(n) && m(t)) {
					if (!n.equalBase(t))throw new Error("Cannot compare units with different base");
					return n.value < t.value
				}
		...
		e.exports = function (e, r) {
			...
			e.smallerEq = function g(n, t) {
				...
				if (u(n) && u(t))return f(n, t, r.epsilon) || t > n;
				if (n instanceof i)return u(t) ? t = i.convert(t) : (c(t) || null === t) && (t = new i(t ? 1 : 0)), t instanceof i ? n.lte(t) : g(n.toNumber(), t);
				if (t instanceof i)return u(n) ? n = i.convert(n) : (c(n) || null === n) && (n = new i(n ? 1 : 0)), n instanceof i ? n.lte(t) : g(n, t.toNumber());
				if (m(n) && m(t)) {
					if (!n.equalBase(t))throw new Error("Cannot compare units with different base");
					return n.value <= t.value
				}
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = n(13), a = r.object, s = r.number.isNumber, u = r["boolean"].isBoolean, f = o.isCollection, c = i.isComplex;
			e.conj = function l(r) {
				if (1 != arguments.length)throw new e.error.ArgumentsError("conj", arguments.length, 1);
				return s(r) ? r : r instanceof t ? new t(r) : c(r) ? new i(r.re, -r.im) : f(r) ? o.deepMap(r, l) : u(r) || null === r ? +r : a.clone(r)
			}
		}
	}, function (e, r, n) {
		"use strict";
		e.exports = function (e) {
			...
			e.re = function l(r) {
				...
				return s(r) ? r : r instanceof t ? new t(r) : c(r) ? r.re : f(r) ? o.deepMap(r, l) : u(r) || null === r ? +r : a.clone(r)
			}
		}
	}, function (e, r, n) {
		"use strict";
		e.exports = function (e) {
			...
			e.im = function c(r) {
				...
				return a(r) ? 0 : r instanceof t ? new t(0) : f(r) ? r.im : u(r) ? o.deepMap(r, c) : s(r) || null === r ? 0 : 0
			}
		}
	}, function (e, r, n) {
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(13), o = i.isCollection, a = r.number.isNumber, s = r.string.isString, u = r["boolean"].isBoolean;
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(13), o = i.isCollection, a = r.number.isNumber, s = r.string.isString;
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = n(13), a = o.isCollection, s = r.number.isNumber, u = r.string.isString, f = i.isComplex;
		...
		"use strict";
		e.exports = function (e) {
			var r = (n(144), e.type.BigNumber), t = n(8);
			e.index = function () {
				var e = Array.prototype.slice.apply(arguments).map(function (e) {
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = e.type.Unit, o = n(13), a = o.isCollection, s = r.number.isNumber, u = r["boolean"].isBoolean, f = r.string.isString;
			e.number = function c(r, n) {
				switch (arguments.length) {
					case 0:
						return 0;
					case 1:
					...
					case 2:
						if (r instanceof i && f(n) || n instanceof i)return r.toNumber(n);
						throw new e.error.UnsupportedTypeError("number", e["typeof"](r), e["typeof"](n));
					default:
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = n(13), i = r.number, o = r.number.isNumber, a = t.isCollection;
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(10), o = n(13), a = o.isCollection, s = r.string.isString;
			e.unit = function u(r) {
				switch (arguments.length) {
					case 1:
						var n = arguments[0];
		...
		e.exports = function (e) {
			...
			var t = n(144), i = n(139), o = n(9), a = n(13), s = t.object, u = t.array, f = t.number.isNumber, c = t.number.isInteger, l = a.isCollection;
			e.concat = function () {
				var n, t, a = arguments.length, p = -1, m = !1, h = [];
				for (n = 0; a > n; n++) {
					var g = arguments[n];
					if (g instanceof o && (m = !0), n == a - 1 && (f(g) || g instanceof i)) {
						if (t = p, p = g.valueOf(), !c(p))throw new TypeError("Integer number expected for dimension");
						if (0 > p)throw new e.error.IndexError(p);
						if (n > 0 && p > t)throw new e.error.IndexError(p, t + 1)
					} else {
						if (!l(g))throw new e.error.UnsupportedTypeError("concat", e["typeof"](g));
						var d = s.clone(g).valueOf(), x = u.size(g.valueOf());
						if (h[n] = d, t = p, p = x.length - 1, n > 0 && p != t)throw new e.error.DimensionError(t + 1, p + 1)
					}
				}
				if (0 == h.length)throw new SyntaxError("At least one matrix expected");
				for (var y = h.shift(); h.length;)y = r(y, h.shift(), p, 0);
				return m ? new o(y) : y
			}
		}
	}, function (e, r, n) {
		...
		e.exports = function (e) {
			function r(r, n) {
				...
				for (var t = function (r) {
					var n, t, i = new Array(r.length), o = 0;
					for (n = 1; n < r.length; n++)o = e.add(o, r[n][n]);
					for (n = 0; n < r.length; n++) {
						for (i[n] = new Array(r.length), i[n][n] = e.unaryMinus(o), t = 0; n > t; t++)i[n][t] = 0;
						for (t = n + 1; t < r.length; t++)i[n][t] = r[n][t];
						n + 1 < r.length && (o = e.subtract(o, r[n + 1][n + 1]))
					}
					return i
				}, i = r, a = 0; n - 1 > a; a++)i = e.multiply(t(i), r);
				return n % 2 == 0 ? e.unaryMinus(i[0][0]) : i[0][0]
			}

			var t = n(144), i = n(9), o = t.object, a = t.string;
			e.det = function (n) {
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(9), o = r.object, a = r.array.isArray, s = r.number.isNumber, u = r.number.isInteger;
			e.diag = function (r, n) {
				var f, c, l, p;
				...
				var m, h = n > 0 ? n : 0, g = 0 > n ? -n : 0;
				if (r instanceof i)m = !1; else {
				...
				switch (d.length) {
					case 1:
						c = r.valueOf();
						var x = new i, y = c[0]instanceof t ? new t(0) : 0;
						for (x.resize([c.length + g, c.length + h], y), f = x.valueOf(), p = c.length, l = 0; p > l; l++)f[l + g][l + h] = o.clone(c[l]);
		...
		"use strict";
		e.exports = function (e, r) {
			var t = n(144), i = e.type.BigNumber, o = n(9), a = n(13), s = t.number.isNumber, u = t.number.isInteger, f = Array.isArray;
			e.eye = function (n) {
				var t = a.argsToArray(arguments), c = n instanceof o ? !0 : f(n) ? !1 : "matrix" === r.matrix;
				if (0 == t.length)return c ? new o : [];
				if (1 == t.length)t[1] = t[0]; else if (t.length > 2)throw new e.error.ArgumentsError("eye", t.length, 0, 2);
				var l = t[0], p = t[1];
				...
				var h = new o, g = m ? new i(1) : 1, d = m ? new i(0) : 0;
				h.resize(t, d);
				for (var x = e.min(t), y = h.valueOf(), w = 0; x > w; w++)y[w][w] = g;
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = n(9), i = r.object, o = r.array, a = Array.isArray;
			e.flatten = function (r) {
				if (1 !== arguments.length)throw new e.error.ArgumentsError("flatten", arguments.length, 1);
				if (r instanceof t) {
					var n = i.clone(r.toArray()), s = o.flatten(n);
					return new t(s)
				}
				if (a(r))return o.flatten(i.clone(r));
		...
		e.exports = function (e) {
			function r(r, n, t) {
				...
				if (2 == n) {
					...
					return [[e.divide(r[1][1], f), e.divide(e.unaryMinus(r[0][1]), f)], [e.divide(e.unaryMinus(r[1][0]), f), e.divide(r[0][0], f)]]
				}
				var c = r.concat();
				...
				for (var l = e.eye(n).valueOf(), p = 0; t > p; p++) {
					...
					for (i = 0; n > i; i++) {
						...
						if (i != p) {
							if (0 != g[p]) {
								for (a = e.divide(e.unaryMinus(g[p]), m[p]), o = p; t > o; o++)g[o] = e.add(g[o], e.multiply(a, m[o]));
		...
		"use strict";
		e.exports = function (e, r) {
			var t = n(144), i = e.type.BigNumber, o = n(9), a = n(13), s = t.array, u = Array.isArray;
			e.ones = function (e) {
				var n = a.argsToArray(arguments), t = e instanceof o ? !0 : u(e) ? !1 : "matrix" === r.matrix;
		...
		e.exports = function (e, r) {
			function t(e, r, n) {
				var t = [], i = e;
				if (n > 0)for (; r > i;)t.push(i), i += n; else if (0 > n)for (; i > r;)t.push(i), i += n;
				return t
			}
			...
			function o(e, r, n) {
				...
				if (n.gt(o))for (; i.lt(r);)t.push(i), i = i.plus(n); else if (n.lt(o))for (; i.gt(r);)t.push(i), i = i.plus(n);
				return t
			}

			function a(e, r, n) {
				var t = [], i = e.clone(), o = new f(0);
				if (n.gt(o))for (; i.lte(r);)t.push(i), i = i.plus(n); else if (n.lt(o))for (; i.gte(r);)t.push(i), i = i.plus(n);
				return t
			}

			function s(e) {
				var n = e.split(":"), t = null;
			...
			var u = n(144), f = e.type.BigNumber, c = n(9), l = (n(13), u["boolean"].isBoolean), p = u.string.isString, m = u.number.isNumber;
			e.range = function () {
				var n, u, h, g = Array.prototype.slice.call(arguments), d = !1;
				...
				if (n instanceof f || u instanceof f || h instanceof f) {
					var y = !0;
					n instanceof f || (n = f.convert(n)), u instanceof f || (u = f.convert(u)), h instanceof f || (h = f.convert(h)), n instanceof f && u instanceof f && h instanceof f || (y = !1, n instanceof f && (n = n.toNumber()), u instanceof f && (u = u.toNumber()), h instanceof f && (h = h.toNumber()))
				}
				var w = y ? d ? a : o : d ? i : t, v = w(n, u, h);
		...
		e.exports = function (e, r) {
			function t(r, n, t) {
				...
				if (1 !== n.length)throw new e.error.DimensionError(n.length, 1);
				var i = n[0];
			...
			var i = n(144), o = e.type.BigNumber, a = n(9), s = i.array, u = i.object.clone, f = i.string, c = i.string.isString, l = i.number.isNumber, p = i.number.isInteger, m = s.isArray;
		...
		"use strict";
		e.exports = function (e, r) {
			var t = n(144), i = e.type.BigNumber, o = n(6), a = n(10), s = n(9), u = t.array, f = t.number.isNumber, c = t["boolean"].isBoolean, l = t.string.isString, p = o.isComplex, m = a.isUnit;
			e.size = function (n) {
		...
		e.exports = function (e) {
			function r(r, n) {
				var i, o;
				if (l(r))return i = new s(r), o = i.subset(n), o && o.valueOf();
			...
			function t(r, n) {
				...
				var t = r.length;
				f.validateIndex(n.min()[0], t), f.validateIndex(n.max()[0], t);
				var i = n.range(0), o = "";
			...
			function o(r, n, t, i) {
				...
				var o = n.range(0), a = o.size()[0];
				if (a != t.length)throw new e.error.DimensionError(o.size()[0], t.length);
				var s = r.length;
				f.validateIndex(n.min()[0]), f.validateIndex(n.max()[0]);
				for (var l = [], p = 0; s > p; p++)l[p] = r.charAt(p);
				if (o.forEach(function (e, r) {
						l[e] = t.charAt(r)
					}), l.length > s)for (p = s - 1, a = l.length; a > p; p++)l[p] || (l[p] = i);
				return l.join("")
			}

			var a = n(144), s = n(9), u = n(8), f = a.array, c = a.string.isString, l = Array.isArray;
			e.subset = function () {
				switch (arguments.length) {
					case 2:
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = n(9), i = r.object, o = r.string;
			e.transpose = function (r) {
				...
				switch (n.length) {
					...
					case 1:
						return i.clone(r);
					case 2:
						var a, s = n[1], u = n[0], f = r instanceof t, c = r.valueOf(), l = [], p = i.clone;
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(13), o = r.number.isNumber, a = r["boolean"].isBoolean, s = r.number.isInteger, u = i.isCollection;
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = r.number.isNumber, o = r.number.isInteger;
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = (n(13), r.number.isNumber), o = r.number.isInteger;
		...
		e.exports = function (e) {
			...
			var i = (n(9), n(13)), o = i.isCollection;
			e.min = function (e) {
		...
		e.exports = function (e) {
			function r(r, n) {
				var t = i.reduce(r, n, e.add), o = s(r) ? a(r) : r.size();
				return e.divide(t, o[n])
			}
			...
			var i = (n(9), n(13)), o = i.isCollection, a = n(137).size, s = Array.isArray;
			e.mean = function (e) {
		...
		e.exports = function (e) {
			...
			var t = (n(9), n(10)), i = e.type.BigNumber, o = n(13), a = n(4).isNumber, s = o.isCollection, u = n(137).flatten;
			e.median = function (e) {
		...
		e.exports = function (e) {
			...
			var t = (n(9), n(13)), i = t.isCollection;
			e.prod = function (e) {
		...
		e.exports = function (e) {
			...
			var t = (n(9), e.type.BigNumber), i = n(13), o = i.isCollection, a = n(160).isString, s = "unbiased";
			e["var"] = function (e, n) {
		...
		e.exports = function (e) {
			...
			e.acos = function c(r) {
				...
				if (u(r)) {
					var n = new i(r.im * r.im - r.re * r.re + 1, -2 * r.re * r.im), l = e.sqrt(n), p = new i(l.re - r.im, l.im + r.re), m = e.log(p);
		...
		e.exports = function (e) {
			...
			e.asin = function c(r) {
				...
				if (u(r)) {
					var n = r.re, l = r.im, p = new i(l * l - n * n + 1, -2 * n * l), m = e.sqrt(p), h = new i(m.re - l, m.im + n), g = e.log(h);
		...
		e.exports = function (e) {
			...
			e.atan = function c(r) {
				...
				if (u(r)) {
					var n = r.re, l = r.im, p = n * n + (1 - l) * (1 - l), m = new i((1 - l * l - n * n) / p, -2 * n / p), h = e.log(m);
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = n(13), a = r.number.isNumber, s = r["boolean"].isBoolean, u = (i.isComplex, o.isCollection);
			e.atan2 = function f(r, n) {
				...
				if (s(r) || null === r)return f(+r, n);
				if (s(n) || null === n)return f(r, +n);
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = n(10), a = n(13), s = r.number.isNumber, u = r["boolean"].isBoolean, f = i.isComplex, c = o.isUnit, l = a.isCollection;
			e.cos = function p(r) {
				...
				if (u(r) || null === r)return Math.cos(r);
		...
		e.exports = function (e) {
			...
			e.cosh = function p(r) {
				...
				if (f(r)) {
					var n = Math.exp(r.re), m = Math.exp(-r.re);
		...
		e.exports = function (e) {
			...
			e.coth = function p(r) {
				...
				if (f(r)) {
					var m = Math.exp(2 * r.re), h = m * Math.cos(2 * r.im), g = m * Math.sin(2 * r.im), d = (h - 1) * (h - 1) + g * g;
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = e.type.BigNumber, i = n(6), o = n(10), a = n(13), s = r.number, u = r.number.isNumber, f = r["boolean"].isBoolean, c = i.isComplex, l = o.isUnit, p = a.isCollection;
			e.csch = function m(r) {
				...
				if (c(r)) {
					var n = Math.exp(r.re), h = Math.exp(-r.re), g = Math.cos(r.im) * (n - h), d = Math.sin(r.im) * (n + h), x = g * g + d * d;
		...
		e.exports = function (e) {
			...
			e.sech = function p(r) {
				...
				if (f(r)) {
					var n = Math.exp(r.re), m = Math.exp(-r.re), h = Math.cos(r.im) * (n + m), g = Math.sin(r.im) * (n - m), d = h * h + g * g;
		...
		e.exports = function (e) {
			...
			e.sin = function p(r) {
				...
				if (l(r))return a.deepMap(r, p);
				if (u(r) || null === r)return Math.sin(r);
				if (r instanceof t)return p(r.toNumber());
		...
		e.exports = function (e) {
			...
			e.sinh = function p(r) {
				...
				if (s(r))return (Math.exp(r) - Math.exp(-r)) / 2;
				if (f(r)) {
					var n = Math.cos(r.im), m = Math.sin(r.im), h = Math.exp(r.re), g = Math.exp(-r.re);
		...
		e.exports = function (e) {
			...
			e.tan = function p(r) {
				...
				if (l(r))return a.deepMap(r, p);
				if (u(r) || null === r)return Math.tan(r);
				if (r instanceof t)return p(r.toNumber());
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = n(10), i = n(13), o = r.string.isString, a = t.isUnit, s = i.isCollection;
			e.to = function u(r, n) {
		...
		e.exports = function (e) {
			function r(r, n, t) {
				(t.override || void 0 === e[r]) && (e[r] = t.wrap && "function" == typeof n ? function () {
					for (var r = [], t = 0, i = arguments.length; i > t; t++) {
						var o = arguments[t];
						r[t] = o && o.valueOf()
					}
					return n.apply(e, r)
			...
			var i = n(144), o = n(6), a = n(10), s = i.number.isNumber, u = i.string.isString, f = o.isComplex, c = a.isUnit;
			e["import"] = function l(i, o) {
				var a = arguments.length;
				if (1 != a && 2 != a)throw new e.error.ArgumentsError("import", a, 1, 2);
				var s, f = {override: o && o.override || !1, wrap: o && o.wrap || !1};
				if (u(i)) {
					var c = n(179)(i);
					l(c, o)
				} else {
		...
		"use strict";
		e.exports = function (e) {
			var r = n(144), t = r.string.isString;
		...
		e.exports = function (e) {
			...
			e.sort = function (n, t) {
				var i = null;
				if (1 === arguments.length)i = e.compare; else {
					if (2 !== arguments.length)throw new e.error.ArgumentsError("sort", arguments.length, 1, 2);
					if ("function" == typeof t)i = t; else if ("asc" === t)i = e.compare; else {
						if ("desc" !== t)throw new e.error.UnsupportedTypeError("sort", e["typeof"](n), e["typeof"](t));
						i = function (r, n) {
				...
				if (n instanceof r) {
					var o = n.size();
					if (o.length > 1)throw new Error("Only one dimensional matrices supported");
					return new r(n.toArray().sort(i))
				}
				if (Array.isArray(n))return n.sort(i);
				throw new e.error.UnsupportedTypeError("sort", e["typeof"](n), e["typeof"](t))
			}
		}
	}, function (e, r, n) {
		"use strict";
		e.exports = function (e) {
			var r = n(180), t = n(6), i = n(9), o = n(10), a = n(8), s = n(7), u = n(11);
			e["typeof"] = function (n) {
		...
		function i(e, r, n) {
			...
			} else for (t = 0; o > t; t++)if (m(e[t]))throw new l(r.length + 1, r.length, ">")
		}

		function o(e, n, t, i) {
			var a, s, u = e.length, f = n[t], l = Math.min(u, f);
			if (e.length = f, t < n.length - 1) {
				var p = t + 1;
				for (a = 0; l > a; a++)s = e[a], m(s) || (s = [s], e[a] = s), o(s, n, p, i);
				for (a = l; f > a; a++)s = [], e[a] = s, o(s, n, p, i)
			} else {
				for (a = 0; l > a; a++)for (; m(e[a]);)e[a] = e[a][0];
				if (i !== r.UNINITIALIZED)for (a = l; f > a; a++)e[a] = c.clone(i)
			}
		}
		...
		function a(e, r, n) {
			...
			if (r > n) {
				var o = n + 1;
				for (t = 0, i = e.length; i > t; t++)e[t] = a(e[t], r, o)
			} else for (; m(e);)e = e[0];
			return e
		}
		...
		function s(e, r, n) {
			...
			if (m(e)) {
				var o = n + 1;
				for (t = 0, i = e.length; i > t; t++)e[t] = s(e[t], r, o)
			} else for (var a = n; r > a; a++)e = [e];
			return e
		}

		var u = n(4), f = n(160), c = n(3), l = (n(180), n(141)), p = n(142), m = Array.isArray;
		r.size = function (e) {
			var n = t(e);
		...
		}, r.UNINITIALIZED = {}, r.resize = function (e, r, n) {
			if (!m(e) || !m(r))throw new TypeError("Array expected");
			if (0 === r.length)throw new Error("Resizing to scalar is not supported");
			r.forEach(function (e) {
				if (!u.isNumber(e) || !u.isInteger(e) || 0 > e)throw new TypeError("Invalid size, must contain positive integers (size: " + f.format(r) + ")")
			});
			var t = void 0 !== n ? n : 0;
			return o(e, r, 0, t), e
		}, r.squeeze = function (e, n) {
			for (var t = n || r.size(e); m(e) && 1 === e.length;)e = e[0], t.shift();
			for (var i = t.length; 1 === t[i - 1];)i--;
			return i < t.length && (e = a(e, i, 0), t.length = i), e
		}, r.unsqueeze = function (e, n, t, i) {
			var o = i || r.size(e);
			if (t)for (var a = 0; t > a; a++)e = [e], o.unshift(1);
			...
			for (var r = [], n = 0, t = e.length; t > n; n++)r[n] = e[n];
			return r
		}, r.isArray = m
	}, function (e) {
		e.exports = "1.0.1"
		...
		!function (i) {
			"use strict";
			function o(e) {
				for (var r, n, t = 1, i = e.length, o = e[0] + ""; i > t; t++) {
					for (r = e[t] + "", n = A - r.length; n--;)r = "0" + r;
					o += r
				}
				for (i = o.length; "0" == o.charAt(--i););
			...
			function a(e, r, n, t) {
				...
				return a = r - o, 0 > a ? (a += A, i = 0) : (i = Math.ceil((a + 1) / A), a %= A), o = N(10, A - a), u = e[i] % o | 0, null == t ? 3 > a ? (0 == a ? u = u / 100 | 0 : 1 == a && (u = u / 10 | 0), s = 4 > n && 99999 == u || n > 3 && 49999 == u || 5e4 == u || 0 == u) : s = (4 > n && u + 1 == o || n > 3 && u + 1 == o / 2) && (e[i + 1] / o / 100 | 0) == N(10, a - 2) - 1 || (u == o / 2 || 0 == u) && 0 == (e[i + 1] / o / 100 | 0) : 4 > a ? (0 == a ? u = u / 1e3 | 0 : 1 == a ? u = u / 100 | 0 : 2 == a && (u = u / 10 | 0), s = (t || 4 > n) && 9999 == u || !t && n > 3 && 4999 == u) : s = ((t || 4 > n) && u + 1 == o || !t && n > 3 && u + 1 == o / 2) && (e[i + 1] / o / 1e3 | 0) == N(10, a - 3) - 1, s
			}

			function s(e, r, n) {
				var t = e.constructor;
				return null == r || ((y = 0 > r || r > 8) || 0 !== r && (t.errors ? parseInt : parseFloat)(r) != r) && !p(t, "rounding mode", r, n, 0) ? t.rounding : 0 | r
			}

			function u(e, r, n, t) {
				var i = e.constructor;
				return !(y = (t || 0) > r || r >= U + 1) && (0 === r || (i.errors ? parseInt : parseFloat)(r) == r) || p(i, "argument", r, n, 0)
			}

			function f(e, r) {
				var n, t, i, s, u, f, c, l = 0, p = 0, m = 0, h = e.constructor, d = h.ONE, x = h.rounding, y = h.precision;
				if (!e.c || !e.c[0] || e.e > 17)return new h(e.c ? e.c[0] ? e.s < 0 ? 0 : 1 / 0 : d : e.s ? e.s < 0 ? 0 : e : 0 / 0);
				for (null == r ? (v = !1, u = y) : u = r, c = new h(.03125); e.e > -2;)e = e.times(c), m += 5;
				for (t = Math.log(N(2, m)) / Math.LN10 * 2 + 5 | 0, u += t, n = s = f = new h(d), h.precision = u; ;) {
					if (s = g(s.times(e), u, 1), n = n.times(++p), c = f.plus(z(s, n, u, 1)), o(c.c).slice(0, u) === o(f.c).slice(0, u)) {
						for (i = m; i--;)f = g(f.times(f), u, 1);
						if (null != r)return h.precision = y, f;
						if (!(3 > l && a(f.c, u - t, x, l)))return g(f, h.precision = y, x, v = !0);
						h.precision = u += 10, n = s = c = new h(d), p = 0, l++
					}
					f = c
				}
			}
			...
			function c(e, r, n, t) {
				var i, a, s = e.constructor, u = (e = new s(e)).e;
				if (null == r ? n = 0 : (g(e, ++r, n), n = t ? r : r + e.e - u), u = e.e, i = o(e.c), 1 == t || 2 == t && (u >= r || u <= s.toExpNeg)) {
					for (; i.length < n; i += "0");
					...
					if (t = i.length, 0 > u) {
						...
						for (a = n - u, u -= t; u--; i += "0");
						a > 0 && (i += ".")
					} else a = n - t, t > u ? i = i.slice(0, u) + "." + i.slice(u) : a > 0 && (i += ".");
					if (a > 0)for (; a--; i += "0");
				}
			...
			function p(e, r, n, t, i) {
				if (e.errors) {
					var o = new Error((t || ["new Decimal", "cmp", "div", "eq", "gt", "gte", "lt", "lte", "minus", "mod", "plus", "times", "toFraction", "pow", "random", "log", "sqrt", "toNearest", "divToInt"][b ? 0 > b ? -b : b : 0 > 1 / b ? 1 : 0]) + "() " + (["number type has more than 15 significant digits", "LN10 out of digits"][r] || r + ([y ? " out of range" : " not an integer", " not a boolean or binary digit"][i] || "")) + ": " + n);
			...
			function m(e, r, n) {
				var t = new e(e.ONE);
				for (v = !1; 1 & n && (t = t.times(r)), n >>= 1, n;)r = r.times(r);
				return v = !0, t
			}

			function h(e, r) {
				var n, t, i, s, u, f, c, l, m, d, x, y = 1, w = 10, b = e, E = b.c, N = b.constructor, M = N.ONE, T = N.rounding, A = N.precision;
				if (b.s < 0 || !E || !E[0] || !b.e && 1 == E[0] && 1 == E.length)return new N(E && !E[0] ? -1 / 0 : 1 != b.s ? 0 / 0 : E ? 0 : b);
				if (null == r ? (v = !1, c = A) : c = r, N.precision = c += w, n = o(E), t = n.charAt(0), !(Math.abs(s = b.e) < 15e14))return b = new N(t + "." + n.slice(1)), c + 2 > B.length && p(N, 1, c + 2, "ln"), b = h(b, c - w).plus(new N(B.slice(0, c + 2)).times(s + "")), N.precision = A, null == r ? g(b, A, T, v = !0) : b;
				for (; 7 > t && 1 != t || 1 == t && n.charAt(1) > 3;)b = b.times(e), n = o(b.c), t = n.charAt(0), y++;
				for (s = b.e, t > 1 ? (b = new N("0." + n), s++) : b = new N(t + "." + n.slice(1)), d = b, l = u = b = z(b.minus(M), b.plus(M), c, 1), x = g(b.times(b), c, 1), i = 3; ;) {
					if (u = g(u.times(x), c, 1), m = l.plus(z(u, new N(i), c, 1)), o(m.c).slice(0, c) === o(l.c).slice(0, c)) {
						if (l = l.times(2), 0 !== s && (c + 2 > B.length && p(N, 1, c + 2, "ln"), l = l.plus(new N(B.slice(0, c + 2)).times(s + ""))), l = z(l, new N(y), c, 1), null != r)return N.precision = A, l;
						if (!a(l.c, c - w, T, f))return g(l, N.precision = A, T, v = !0);
						N.precision = c += w, m = u = b = z(d.minus(M), d.plus(M), c, 1), x = g(b.times(b), c, 1), i = f = 1
					}
					l = m, i += 2
				}
			}
			...
			function g(e, r, n, t) {
				var i, o, a, s, u, f, c, l, p = e.constructor;
				e:if (r != o) {
					if (!(c = e.c))return e;
					for (i = 1, s = c[0]; s >= 10; s /= 10, i++);
					if (o = r - i, 0 > o)o += A, a = r, u = c[l = 0], f = u / N(10, i - a - 1) % 10 | 0; else if (l = Math.ceil((o + 1) / A), l >= c.length) {
						if (!t)break e;
						for (; c.length <= l; c.push(0));
						u = f = 0, i = 1, o %= A, a = o - A + 1
					} else {
						for (u = s = c[l], i = 1; s >= 10; s /= 10, i++);
						o %= A, a = o - A + i, f = 0 > a ? 0 : E(u / N(10, i - a - 1) % 10)
					}
					if (t = t || 0 > r || null != c[l + 1] || (0 > a ? u : u % N(10, i - a - 1)), t = 4 > n ? (f || t) && (0 == n || n == (e.s < 0 ? 3 : 2)) : f > 5 || 5 == f && (4 == n || t || 6 == n && (o > 0 ? a > 0 ? u / N(10, i - a) : 0 : c[l - 1]) % 10 & 1 || n == (e.s < 0 ? 8 : 7)), 1 > r || !c[0])return c.length = 0, t ? (r -= e.e + 1, c[0] = N(10, r % A), e.e = -r || 0) : c[0] = e.e = 0, e;
					if (0 == o ? (c.length = l, s = 1, l--) : (c.length = l + 1, s = N(10, A - o), c[l] = a > 0 ? (u / N(10, i - a) % N(10, a) | 0) * s : 0), t)for (; ;) {
						if (0 == l) {
							for (o = 1, a = c[0]; a >= 10; a /= 10, o++);
							for (a = c[0] += s, s = 1; a >= 10; a /= 10, s++);
							o != s && (e.e++, c[0] == T && (c[0] = 1));
							break
						}
						if (c[l] += s, c[l] != T)break;
						c[l--] = 0, s = 1
					}
					for (o = c.length; 0 === c[--o]; c.pop());
				}
				return v && (e.e > p.maxE ? e.c = e.e = null : e.e < p.minE && (e.c = [e.e = 0])), e
			}
			...
			O.absoluteValue = O.abs = function () {
				...
				var n, t = this, i = t.c, o = (b = -b, e = new t.constructor(e, r), e.c), a = t.s, s = e.s, u = t.e, f = e.e;
				if (!a || !s)return null;
				if (n = i && !i[0], r = o && !o[0], n || r)return n ? r ? 0 : -s : a;
				if (a != s)return a;
				if (n = 0 > a, !i || !o)return u == f ? 0 : !i ^ n ? 1 : -1;
				if (u != f)return u > f ^ n ? 1 : -1;
				for (a = -1, s = (u = i.length) < (f = o.length) ? u : f; ++a < s;)if (i[a] != o[a])return i[a] > o[a] ^ n ? 1 : -1;
				return u == f ? 0 : u > f ^ n ? 1 : -1
			}, O.decimalPlaces = O.dp = function () {
				var e, r, n = null;
				if (e = this.c) {
					if (n = ((r = e.length - 1) - E(this.e / A)) * A, r = e[r])for (; r % 10 == 0; r /= 10, n--);
					0 > n && (n = 0)
				}
				return n
			}, O.dividedBy = O.div = function (e, r) {
				return b = 2, z(this, new this.constructor(e, r))
			}, O.dividedToIntegerBy = O.divToInt = function (e, r) {
				var n = this, t = n.constructor;
				return b = 18, g(z(n, new t(e, r), 0, 1, 1), t.precision, t.rounding)
				...
				var n, t, i, s, u, f, c, l, m, d = this, x = d.constructor, y = x.precision, w = x.rounding, E = 5;
				if (null == e)e = new x(10), n = !0; else {
					if (b = 15, e = new x(e, r), t = e.c, e.s < 0 || !t || !t[0] || !e.e && 1 == t[0] && 1 == t.length)return new x(0 / 0);
					n = e.eq(10)
				}
				if (t = d.c, d.s < 0 || !t || !t[0] || !d.e && 1 == t[0] && 1 == t.length)return new x(t && !t[0] ? -1 / 0 : 1 != d.s ? 0 / 0 : t ? 0 : 1 / 0);
				if (u = n && (s = t[0], t.length > 1 || 1 != s && 10 != s && 100 != s && 1e3 != s && 1e4 != s && 1e5 != s && 1e6 != s), v = !1, c = y + E, l = c + 10, f = h(d, c), n ? (l > B.length && p(x, 1, l, "log"), i = new x(B.slice(0, l))) : i = h(e, c), m = z(f, i, c, 1), a(m.c, s = y, w))do if (c += 10, f = h(d, c), n ? (l = c + 10, l > B.length && p(x, 1, l, "log"), i = new x(B.slice(0, l))) : i = h(e, c), m = z(f, i, c, 1), !u) {
					+o(m.c).slice(s + 1, s + 15) + 1 == 1e14 && (m = g(m, y + 1, 0));
					break
				} while (a(m.c, s += 10, w));
				return v = !0, g(m, y, w)
			}, O.minus = function (e, r) {
				var n, t, i, o, a = this, s = a.constructor, u = a.s;
				if (b = 8, e = new s(e, r), r = e.s, !u || !r)return new s(0 / 0);
				if (u != r)return e.s = -r, a.plus(e);
				var f = a.c, c = e.c, l = E(e.e / A), p = E(a.e / A), m = s.precision, h = s.rounding;
				if (!p || !l) {
					if (!f || !c)return f ? (e.s = -r, e) : new s(c ? a : 0 / 0);
					if (!f[0] || !c[0])return a = c[0] ? (e.s = -r, e) : new s(f[0] ? a : 3 == h ? -0 : 0), v ? g(a, m, h) : a
				}
				if (f = f.slice(), t = f.length, u = p - l) {
					for ((o = 0 > u) ? (u = -u, n = f, t = c.length) : (l = p, n = c), (p = Math.ceil(m / A)) > t && (t = p), u > (t += 2) && (u = t, n.length = 1), n.reverse(), r = u; r--; n.push(0));
					n.reverse()
				} else for ((o = t < (i = c.length)) && (i = t), u = r = 0; i > r; r++)if (f[r] != c[r]) {
					o = f[r] < c[r];
					break
				}
				if (o && (n = f, f = c, c = n, e.s = -e.s), (r = -((i = f.length) - c.length)) > 0)for (; r--; f[i++] = 0);
				for (p = T - 1, r = c.length; r > u;) {
					if (f[--r] < c[r]) {
						for (t = r; t && !f[--t]; f[t] = p);
						--f[t], f[r] += T
					}
				...
				for (; 0 == f[--i]; f.pop());
				for (; 0 == f[0]; f.shift(), --l);
				for (f[0] || (f = [l = 0], e.s = 3 == h ? -1 : 1), e.c = f, u = 1, r = f[0]; r >= 10; r /= 10, u++);
				return e.e = u + l * A - 1, v ? g(e, m, h) : e
			}, O.modulo = O.mod = function (e, r) {
				var n, t, i = this, o = i.constructor, a = o.modulo;
				return b = 9, e = new o(e, r), r = e.s, n = !i.c || !r || e.c && !e.c[0], n || !e.c || i.c && !i.c[0] ? n ? new o(0 / 0) : g(new o(i), o.precision, o.rounding) : (v = !1, 9 == a ? (e.s = 1, t = z(i, e, 0, 3, 1), e.s = r, t.s *= r) : t = z(i, e, 0, a, 1), t = t.times(e), v = !0, i.minus(t))
				...
				var n, t = this, i = t.constructor, o = t.s;
				if (b = 10, e = new i(e, r), r = e.s, !o || !r)return new i(0 / 0);
				if (o != r)return e.s = -r, t.minus(e);
				var a = t.c, s = e.c, u = E(e.e / A), f = E(t.e / A), c = i.precision, l = i.rounding;
				if (!f || !u) {
					if (!a || !s)return new i(o / 0);
					if (!a[0] || !s[0])return t = s[0] ? e : new i(a[0] ? t : 0 * o), v ? g(t, c, l) : t
				}
				if (a = a.slice(), o = f - u) {
					for (0 > o ? (o = -o, n = a, r = s.length) : (u = f, n = s, r = a.length), (f = Math.ceil(c / A)) > r && (r = f), o > ++r && (o = r, n.length = 1), n.reverse(); o--; n.push(0));
					n.reverse()
				}
				for (a.length - s.length < 0 && (n = s, s = a, a = n), o = s.length, r = 0, f = T; o; a[o] %= f)r = (a[--o] = a[o] + s[o] + r) / f | 0;
				for (r && (a.unshift(r), ++u), o = a.length; 0 == a[--o]; a.pop());
				for (e.c = a, o = 1, r = a[0]; r >= 10; r /= 10, o++);
				return e.e = o + u * A - 1, v ? g(e, c, l) : e
			}, O.precision = O.sd = function (e) {
				var r = null, n = this;
				return e != r && e !== !!e && 1 !== e && 0 !== e && p(n.constructor, "argument", e, "precision", 1), n.c && (r = l(n.c), e && n.e + 1 > r && (r = n.e + 1)), r
			}, O.round = function () {
				var e = this, r = e.constructor;
				return g(new r(e), e.e + 1, r.rounding)
			}, O.squareRoot = O.sqrt = function () {
				var e, r, n, t, i, a, s = this, u = s.c, f = s.s, c = s.e, l = s.constructor, p = new l(.5);
				if (1 !== f || !u || !u[0])return new l(!f || 0 > f && (!u || u[0]) ? 0 / 0 : u ? s : 1 / 0);
				for (v = !1, f = Math.sqrt(+s), 0 == f || f == 1 / 0 ? (r = o(u), (r.length + c) % 2 == 0 && (r += "0"), f = Math.sqrt(r), c = E((c + 1) / 2) - (0 > c || c % 2), f == 1 / 0 ? r = "1e" + c : (r = f.toExponential(), r = r.slice(0, r.indexOf("e") + 1) + c), t = new l(r)) : t = new l(f.toString()), n = (c = l.precision) + 3; ;)if (a = t, t = p.times(a.plus(z(s, a, n + 2, 1))), o(a.c).slice(0, n) === (r = o(t.c)).slice(0, n)) {
					if (r = r.slice(n - 3, n + 1), "9999" != r && (i || "4999" != r)) {
						(!+r || !+r.slice(1) && "5" == r.charAt(0)) && (g(t, c + 1, 1), e = !t.times(t).eq(s));
						break
					}
					if (!i && (g(a, c + 1, 0), a.times(a).eq(s))) {
						t = a;
						break
					}
					n += 4, i = 1
				}
				return v = !0, g(t, c, l.rounding, e)
			}, O.times = function (e, r) {
				var n, t, i = this, o = i.constructor, a = i.c, s = (b = 11, e = new o(e, r), e.c), u = E(i.e / A), f = E(e.e / A), c = i.s;
				if (r = e.s, e.s = c == r ? 1 : -1, !((u || a && a[0]) && (f || s && s[0])))return new o(!c || !r || a && !a[0] && !s || s && !s[0] && !a ? 0 / 0 : a && s ? 0 * e.s : e.s / 0);
				for (t = u + f, c = a.length, r = s.length, r > c && (n = a, a = s, s = n, f = c, c = r, r = f), f = c + r, n = []; f--; n.push(0));
				for (u = r - 1; u > -1; u--) {
					for (r = 0, f = c + u; f > u; r = r / T | 0)r = n[f] + s[u] * a[f - u - 1] + r, n[f--] = r % T | 0;
					r && (n[f] = (n[f] + r) % T)
				}
				for (r && ++t, n[0] || n.shift(), f = n.length; !n[--f]; n.pop());
				for (e.c = n, c = 1, r = n[0]; r >= 10; r /= 10, c++);
				return e.e = c + t * A - 1, v ? g(e, o.precision, o.rounding) : e
			}, O.toDecimalPlaces = O.toDP = function (e, r) {
				var n = this;
				return n = new n.constructor(n), null != e && u(n, e, "toDP") ? g(n, (0 | e) + n.e + 1, s(n, r, "toDP")) : n
			}, O.toExponential = function (e, r) {
				var n = this;
				return n.c ? c(n, null != e && u(n, e, "toExponential") ? 0 | e : null, null != e && s(n, r, "toExponential"), 1) : n.toString()
			}, O.toFixed = function (e, r) {
				var n, t = this, i = t.constructor, o = i.toExpNeg, a = i.toExpPos;
				return null != e && (e = u(t, e, n = "toFixed") ? t.e + (0 | e) : null, r = s(t, r, n)), i.toExpNeg = -(i.toExpPos = 1 / 0), null != e && t.c ? (n = c(t, e, r), t.s < 0 && t.c && (t.c[0] ? n.indexOf("-") < 0 && (n = "-" + n) : n = n.replace("-", ""))) : n = t.toString(), i.toExpNeg = o, i.toExpPos = a, n
				...
				var r, n, t, i, a, s, u, f, c = this, m = c.constructor, h = r = new m(m.ONE), g = s = new m(0), d = c.c, x = new m(g);
				if (!d)return c.toString();
				for (t = x.e = l(d) - c.e - 1, x.c[0] = N(10, (u = t % A) < 0 ? A + u : u), (null == e || (!(b = 12, a = new m(e)).s || (y = a.cmp(h) < 0 || !a.c) || m.errors && E(a.e / A) < a.c.length - 1) && !p(m, "max denominator", e, "toFraction", 0) || (e = a).cmp(x) > 0) && (e = t > 0 ? x : h), v = !1, a = new m(o(d)), u = m.precision, m.precision = t = d.length * A * 2; f = z(a, x, 0, 1, 1), n = r.plus(f.times(g)), 1 != n.cmp(e);)r = g, g = n, h = s.plus(f.times(n = h)), s = n, x = a.minus(f.times(n = x)), a = n;
				return n = z(e.minus(r), g, 0, 1, 1), s = s.plus(n.times(h)), r = r.plus(n.times(g)), s.s = h.s = c.s, i = z(h, g, t, 1).minus(c).abs().cmp(z(s, r, t, 1).minus(c).abs()) < 1 ? [h + "", g + ""] : [s + "", r + ""], v = !0, m.precision = u, i
			}, O.toNearest = function (e, r) {
				var n = this, t = n.constructor;
				return n = new t(n), null == e ? (e = new t(t.ONE), r = t.rounding) : (b = 17, e = new t(e), r = s(n, r, "toNearest")), e.c ? n.c && (e.c[0] ? (v = !1, n = z(n, e, 0, 4 > r ? [4, 5, 7, 8][r] : r, 1).times(e), v = !0, g(n)) : n.c = [n.e = 0]) : n.s && (e.s && (e.s = n.s), n = e), n
			}, O.toNumber = function () {
				var e = this;
				return +e || (e.s ? 0 * e.s : 0 / 0)
			}, O.toPower = O.pow = function (e, r) {
				var n, t, i, s, u = this, c = u.constructor, l = u.s, p = (b = 13, +(e = new c(e, r))), d = 0 > p ? -p : p, x = c.precision, y = c.rounding;
				if (!u.c || !e.c || (i = !u.c[0]) || !e.c[0])return new c(N(i ? 0 * l : +u, p));
				if (u = new c(u), n = u.c.length, !u.e && u.c[0] == u.s && 1 == n)return u;
				if (r = e.c.length - 1, e.e || e.c[0] != e.s || r)if (t = E(e.e / A), i = t >= r, !i && 0 > l)s = new c(0 / 0); else {
					if (i && q > n * A * d) {
						if (s = m(c, u, d), e.s < 0)return c.ONE.div(s)
					} else {
						if (l = 0 > l && 1 & e.c[Math.max(t, r)] ? -1 : 1, r = N(+u, p), t = 0 != r && isFinite(r) ? new c(r + "").e : E(p * (Math.log("0." + o(u.c)) / Math.LN10 + u.e + 1)), t > c.maxE + 1 || t < c.minE - 1)return new c(t > 0 ? l / 0 : 0);
						v = !1, c.rounding = u.s = 1, d = Math.min(12, (t + "").length), s = f(e.times(h(u, x + d)), x), s = g(s, x + 5, 1), a(s.c, x, y) && (t = x + 10, s = g(f(e.times(h(u, t + d)), t), t + 5, 1), +o(s.c).slice(x + 1, x + 15) + 1 == 1e14 && (s = g(s, x + 1, 0))), s.s = l, v = !0, c.rounding = y
					}
					s = g(s, x, y)
				} else s = g(u, x, y);
				return s
				...
				var n = this;
				return null != e && u(n, e, "toPrecision", 1) && n.c ? c(n, 0 | --e, s(n, r, "toPrecision"), 2) : n.toString()
			}, O.toSignificantDigits = O.toSD = function (e, r) {
				var n = this, t = n.constructor;
				return n = new t(n), null != e && u(n, e, "toSD", 1) ? g(n, 0 | e, s(n, r, "toSD")) : g(n, t.precision, t.rounding)
			}, O.toString = function (e) {
				var r, n, t, i = this, a = i.constructor, s = i.e;
				if (null === s)n = i.s ? "Infinity" : "NaN"; else {
					if (e === r && (s <= a.toExpNeg || s >= a.toExpPos))return c(i, null, a.rounding, 1);
					if (n = o(i.c), 0 > s) {
						for (; ++s; n = "0" + n);
						n = "0." + n
					} else if (t = n.length, s > 0)if (++s > t)for (s -= t; s--; n += "0"); else t > s && (n = n.slice(0, s) + "." + n.slice(s)); else if (r = n.charAt(0), t > 1)n = r + "." + n.slice(1); else if ("0" == r)return r;
					if (null != e)if ((y = !(e >= 2 && 65 > e)) || e != (0 | e) && a.errors)p(a, "base", e, "toString", 0); else if (n = d(a, n, 0 | e, 10, i.s), "0" == n)return n
				}
				return i.s < 0 ? "-" + n : n
				...
				function e(e, r, n) {
					for (var t, i, o = [0], a = 0, s = e.length; s > a;) {
						...
						for (o[t = 0] += S.indexOf(e.charAt(a++)); t < o.length; t++)o[t] > n - 1 && (null == o[t + 1] && (o[t + 1] = 0), o[t + 1] += o[t] / n | 0, o[t] %= n)
					}
					return o.reverse()
				}

				return function (r, n, t, i, o) {
					var a, s, u, f, c, l, p = n.indexOf("."), h = r.precision, g = r.rounding;
					for (37 > i && (n = n.toLowerCase()), p >= 0 && (n = n.replace(".", ""), l = new r(i), f = m(r, l, n.length - p), l.c = e(f.toFixed(), 10, t), l.e = l.c.length), c = e(n, i, t), a = s = c.length; 0 == c[--s]; c.pop());
					if (!c[0])return "0";
					if (0 > p ? a-- : (f.c = c, f.e = a, f.s = o, f = z(f, l, h, g, 0, t), c = f.c, u = f.r, a = f.e), p = c[h], s = t / 2, u = u || null != c[h + 1], 4 > g ? (null != p || u) && (0 == g || g == (f.s < 0 ? 3 : 2)) : p > s || p == s && (4 == g || u || 6 == g && 1 & c[h - 1] || g == (f.s < 0 ? 8 : 7)))for (c.length = h, --t; ++c[--h] > t;)c[h] = 0, h || (++a, c.unshift(1)); else c.length = h;
					for (s = c.length; !c[--s];);
					for (p = 0, n = ""; s >= p; n += S.charAt(c[p++]));
					if (0 > a) {
						for (; ++a; n = "0" + n);
						n = "0." + n
					} else if (p = n.length, ++a > p)for (a -= p; a--; n += "0"); else p > a && (n = n.slice(0, a) + "." + n.slice(a));
					return n
				}
			}();
			var z = function () {
				function e(e, r, n) {
					var t, i = 0, o = e.length;
					for (e = e.slice(); o--;)t = e[o] * r + i, e[o] = t % n | 0, i = t / n | 0;
					return i && e.unshift(i), e
				}

				function r(e, r, n, t) {
					var i, o;
					if (n != t)o = n > t ? 1 : -1; else for (i = o = 0; n > i; i++)if (e[i] != r[i]) {
						o = e[i] > r[i] ? 1 : -1;
						break
					}
					return o
				...
				return function (t, i, o, a, s, u) {
					var f, c, l, p, m, h, d, x, y, w, v, b, N, M, S, O, C, U, q, B = t.constructor, z = t.s == i.s ? 1 : -1, I = t.c, _ = i.c;
					if (!(I && I[0] && _ && _[0]))return new B(t.s && i.s && (I ? !_ || I[0] != _[0] : _) ? I && 0 == I[0] || !_ ? 0 * z : z / 0 : 0 / 0);
					for (u ? (p = 1, c = t.e - i.e) : (u = T, p = A, c = E(t.e / p) - E(i.e / p)), U = _.length, O = I.length, y = new B(z), w = y.c = [], l = 0; _[l] == (I[l] || 0); l++);
					if (_[l] > (I[l] || 0) && c--, null == o ? (z = o = B.precision, a = B.rounding) : z = s ? o + (t.e - i.e) + 1 : o, 0 > z)w.push(1), m = !0; else {
						if (z = z / p + 2 | 0, l = 0, 1 == U) {
							for (h = 0, _ = _[0], z++; (O > l || h) && z--; l++)M = h * u + (I[l] || 0), w[l] = M / _ | 0, h = M % _ | 0;
							m = h || O > l
						} else {
							for (h = u / (_[0] + 1) | 0, h > 1 && (_ = e(_, h, u), I = e(I, h, u), U = _.length, O = I.length), S = U, v = I.slice(0, U), b = v.length; U > b; v[b++] = 0);
							q = _.slice(), q.unshift(0), C = _[0], _[1] >= u / 2 && C++;
							do h = 0, f = r(_, v, U, b), 0 > f ? (N = v[0], U != b && (N = N * u + (v[1] || 0)), h = N / C | 0, h > 1 ? (h >= u && (h = u - 1), d = e(_, h, u), x = d.length, b = v.length, f = r(d, v, x, b), 1 == f && (h--, n(d, x > U ? q : _, x, u))) : (0 == h && (f = h = 1), d = _.slice()), x = d.length, b > x && d.unshift(0), n(v, d, b, u), -1 == f && (b = v.length, f = r(_, v, U, b), 1 > f && (h++, n(v, b > U ? q : _, b, u))), b = v.length) : 0 === f && (h++, v = [0]), w[l++] = h, f && v[0] ? v[b++] = I[S] || 0 : (v = [I[S]], b = 1); while ((S++ < O || null != v[0]) && z--);
							m = null != v[0]
						}
						w[0] || w.shift()
					}
					if (1 == p)y.e = c, y.r = +m; else {
						for (l = 1, z = w[0]; z >= 10; z /= 10, l++);
						y.e = l + c * p - 1, g(y, s ? o + y.e + 1 : o, a, m)
					}
					return y
				}
			}();
			x = function () {
				function e(e) {
					var r, n, t, i = this, o = "config", a = i.errors ? parseInt : parseFloat;
					return e == n || "object" != typeof e && !p(i, "object expected", e, o) ? i : ((t = e[r = "precision"]) != n && ((y = 1 > t || t > U) || a(t) != t ? p(i, r, t, o, 0) : i[r] = 0 | t), (t = e[r = "rounding"]) != n && ((y = 0 > t || t > 8) || a(t) != t ? p(i, r, t, o, 0) : i[r] = 0 | t), (t = e[r = "toExpNeg"]) != n && ((y = -C > t || t > 0) || a(t) != t ? p(i, r, t, o, 0) : i[r] = E(t)), (t = e[r = "toExpPos"]) != n && ((y = 0 > t || t > C) || a(t) != t ? p(i, r, t, o, 0) : i[r] = E(t)), (t = e[r = "minE"]) != n && ((y = -C > t || t > 0) || a(t) != t ? p(i, r, t, o, 0) : i[r] = E(t)), (t = e[r = "maxE"]) != n && ((y = 0 > t || t > C) || a(t) != t ? p(i, r, t, o, 0) : i[r] = E(t)), (t = e[r = "errors"]) != n && (t === !!t || 1 === t || 0 === t ? (y = b = 0, i[r] = !!t) : p(i, r, t, o, 1)), (t = e[r = "crypto"]) != n && (t === !!t || 1 === t || 0 === t ? i[r] = !(!t || !w || "object" != typeof w) : p(i, r, t, o, 1)), (t = e[r = "modulo"]) != n && ((y = 0 > t || t > 9) || a(t) != t ? p(i, r, t, o, 0) : i[r] = 0 | t), i)
				}
				...
				function i(e, r, n) {
					var t, i, o = 0;
					for ("[object Array]" == M.call(r[0]) && (r = r[0]), t = new e(r[0]); ++o < r.length;) {
						if (i = new e(r[o]), !i.s) {
							t = i;
							break
						}
				...
				function f(e) {
					var r, n, t, i = 0, o = [], a = this, s = new a(a.ONE);
					if (null != e && u(s, e, "random") ? e |= 0 : e = a.precision, n = Math.ceil(e / A), a.crypto)if (w && w.getRandomValues)for (r = w.getRandomValues(new Uint32Array(n)); n > i;)t = r[i], t >= 429e7 ? r[i] = w.getRandomValues(new Uint32Array(1))[0] : o[i++] = t % 1e7; else if (w && w.randomBytes) {
						for (r = w.randomBytes(n *= 4); n > i;)t = r[i] + (r[i + 1] << 8) + (r[i + 2] << 16) + ((127 & r[i + 3]) << 24), t >= 214e7 ? w.randomBytes(4).copy(r, i) : (o.push(t % 1e7), i += 4);
						i = n / 4
					} else p(a, "crypto unavailable", w, "random");
					if (!i)for (; n > i;)o[i++] = 1e7 * Math.random() | 0;
					for (n = o[--i], e %= A, n && e && (t = N(10, A - e), o[i] = (n / t | 0) * t); 0 === o[i]; i--)o.pop();
					if (0 > i)o = [n = 0]; else {
						for (n = -1; 0 === o[0];)o.shift(), n -= A;
						for (i = 1, t = o[0]; t >= 10;)t /= 10, i++;
						A > i && (n -= A - i)
					}
					return s.e = n, s.c = o, s
				}
				...
				function l(i) {
					function u(e, r) {
						var n = this;
						if (!(n instanceof u))return p(u, "Decimal called without new", e), new u(e, r);
						if (e instanceof u) {
							if (null == r)return b = 0, n.constructor = e.constructor, n.s = e.s, n.e = e.e, void(n.c = (e = e.c) ? e.slice() : e);
							if (10 == r)return g(new u(e), u.precision, u.rounding);
							e += ""
						}
						return m(n.constructor = u, n, e, r)
					}
				...
				var m = function () {
					var e = /^-?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, r = String.prototype.trim || function () {
							return this.replace(/^\s+|\s+$/g, "")
						};
					return function (n, t, i, o) {
						var a, s, u, f, c, l;
						if ("string" != typeof i && (i = (f = "number" == typeof i || "[object Number]" == M.call(i)) && 0 === i && 0 > 1 / i ? "-0" : i + ""), c = i, o == s && e.test(i))t.s = "-" == i.charAt(0) ? (i = i.slice(1), -1) : 1; else {
							if (10 == o)return g(new n(i), n.precision, n.rounding);
							if (i = r.call(i).replace(/^\+(?!-)/, ""), t.s = "-" == i.charAt(0) ? (i = i.replace(/^-(?!-)/, ""), -1) : 1, o != s ? o != (0 | o) && n.errors || (y = !(o >= 2 && 65 > o)) ? (p(n, "base", o, 0, 0), l = e.test(i)) : (a = "[" + S.slice(0, o = 0 | o) + "]+", i = i.replace(/\.$/, "").replace(/^\./, "0."), (l = new RegExp("^" + a + "(?:\\." + a + ")?$", 37 > o ? "i" : "").test(i)) ? (f && (i.replace(/^0\.0*|\./, "").length > 15 && p(n, 0, c), f = !f), i = d(n, i, 10, o, t.s)) : "Infinity" != i && "NaN" != i && (p(n, "not a base " + o + " number", c), i = "NaN")) : l = e.test(i), !l)return t.c = t.e = null, "Infinity" != i && ("NaN" != i && p(n, "not a number", c), t.s = null), b = 0, t
						}
						for ((s = i.indexOf(".")) > -1 && (i = i.replace(".", "")), (u = i.search(/e/i)) > 0 ? (0 > s && (s = u), s += +i.slice(u + 1), i = i.substring(0, u)) : 0 > s && (s = i.length), u = 0; "0" == i.charAt(u); u++);
						for (o = i.length; "0" == i.charAt(--o););
						if (i = i.slice(u, o + 1)) {
							if (o = i.length, f && o > 15 && p(n, 0, c), t.e = s = s - u - 1, t.c = [], u = (s + 1) % A, 0 > s && (u += A), o > u) {
								for (u && t.c.push(+i.slice(0, u)), o -= A; o > u;)t.c.push(+i.slice(u, u += A));
								i = i.slice(u), u = A - i.length
							} else u -= o;
							for (; u--; i += "0");
							t.c.push(+i), v && (t.e > n.maxE ? t.c = t.e = null : t.e < n.minE && (t.c = [t.e = 0]))
						} else t.c = [t.e = 0];
						b = 0
					}
				}();
		...
		"use strict";
		r.array = n(137), r["boolean"] = n(159), r.number = n(4), r.bignumber = n(136), r.object = n(3), r.string = n(160), r.types = n(180)
	}, function (e, r, n) {
		"use strict";
		function t(e) {
			if (!(this instanceof t))throw new SyntaxError("Constructor must be called with the new operator");
		...
		var i = n(157), o = (n(3), n(160)), a = (n(13), n(144), Array.isArray), s = i.isNode;
		t.prototype = new i, t.prototype.type = "ArrayNode", t.prototype._compile = function (e) {
			var r = "array" !== e.math.config().matrix, n = this.nodes.map(function (r) {
				return r._compile(e)
			});
			...
			return this.nodes.forEach(function (e) {
				r += e.nodes ? e.nodes.map(function (e) {
					return e.toTex()
				}).join("&") : e.toTex(), r += "\\\\"
			}), r += "\\end{" + e + "}"
		}, e.exports = t
		...
		var i = n(157), o = n(145), a = n(283), s = n(284), u = n(160).isString;
		...
		}, t.prototype.toTex = function () {
			var e;
			return this.expr instanceof o && (e = ["\\mathbf{", "}"]), s.addBraces(s.toSymbol(this.name), e) + "=" + s.addBraces(this.expr.toTex())
		}, e.exports = t
	}, function (e, r, n) {
		"use strict";
		function t() {
		...
		var i = n(157), o = n(12), a = n(159).isBoolean;
		t.prototype = new i, t.prototype.type = "BlockNode", t.prototype.add = function (e, r) {
			...
			if (!a(r))throw new TypeError('Boolean expected for parameter "visible"');
			var n = this.params.length;
			this.params[n] = {node: e, visible: r}
		...
		function t(e, r, n) {
			...
			if (!(n instanceof i))throw new TypeError("Parameter falseExpr must be a Node");
			this.condition = e, this.trueExpr = r, this.falseExpr = n
		}

		var i = n(157), o = n(284), a = n(139), s = n(6), u = n(10), f = n(144), c = f.string.isString, l = f.number.isNumber, p = f["boolean"].isBoolean;
		t.prototype = new i, t.prototype.type = "ConditionalNode", t.prototype._compile = function (e) {
			return e.testCondition = function (r) {
				if (l(r) || p(r) || c(r))return r ? !0 : !1;
			...
			var r = [];
			return this.match(e) && r.push(this), r = r.concat(this.condition.find(e), this.trueExpr.find(e), this.falseExpr.find(e))
		}, t.prototype.toString = function () {
			return "(" + this.condition.toString() + ") ? (" + this.trueExpr.toString() + ") : (" + this.falseExpr.toString() + ")"
		}, t.prototype.toTex = function () {
			var e = o.addBraces(this.trueExpr.toTex()) + ", &\\quad" + o.addBraces("\\text{if}\\;" + this.condition.toTex()) + "\\\\" + (o.addBraces(this.falseExpr.toTex()) + ", &\\quad" + o.addBraces("\\text{otherwise}"));
			return o.addBraces(e, ["\\left\\{\\begin{array}{l l}", "\\end{array}\\right."])
		}, e.exports = t
	}, function (e, r, n) {
		"use strict";
		function t(e, r) {
		...
		var i = n(157), o = (n(139), n(180).type), a = n(160).isString, s = {
			number: !0,
			string: !0,
			"boolean": !0,
			undefined: !0,
		...
		t.prototype = new i, t.prototype.type = "ConstantNode", t.prototype._compile = function (e) {
			...
			switch (this.valueType) {
				case"string":
					return "\\text{" + r + "}";
				case"number":
					return e = r.toLowerCase().indexOf("e"), -1 !== e ? r.substring(0, e) + " \\cdot 10^{" + r.substring(e + 1) + "}" : r;
				default:
					return r
			}
		}, e.exports = t
		...
		function t(e, r, n) {
			...
			if (!u(r) || !r.every(s))throw new TypeError('Array containing strings expected for parameter "args"');
		...
		var i = n(157), o = n(283), a = n(284), s = n(160).isString, u = Array.isArray;
		t.prototype = new i, t.prototype.type = "FunctionAssignmentNode", t.prototype._compile = function (e) {
		...
		function t(e, r) {
			...
			if (!c(r) || !r.every(f))throw new TypeError('Array containing Nodes expected for parameter "ranges"');
			this.object = e, this.ranges = r
		}

		var i = n(157), o = n(154), a = n(155), s = n(139), u = n(7), f = i.isNode, c = Array.isArray;
		t.prototype = new i, t.prototype.type = "IndexNode", t.prototype._compile = function (e) {
			...
			var n = {type: a, properties: {name: "end"}}, t = !1, i = this.ranges.map(function (e) {
				var r = e.find(n).length > 0;
				return t = r ? r : t, r
			});
			e.range = function (e, r, n) {
				return new u(e instanceof s ? e.toNumber() : e, r instanceof s ? r.toNumber() : r, n instanceof s ? n.toNumber() : n)
			};
			var f = this.ranges.map(function (r, n) {
				var t = i[n];
				return r instanceof o ? t ? '(function (scope) {  scope = Object.create(scope);   scope["end"] = size[' + n + "];  return range(    " + r.start._compile(e) + ",     " + r.end._compile(e) + ",     " + (r.step ? r.step._compile(e) : "1") + "  );})(scope)" : "range(" + r.start._compile(e) + ", " + r.end._compile(e) + ", " + (r.step ? r.step._compile(e) : "1") + ")" : t ? '(function (scope) {  scope = Object.create(scope);   scope["end"] = size[' + n + "];  return " + r._compile(e) + ";})(scope)" : r._compile(e)
			});
			return t ? "(function () {  var obj = " + this.object._compile(e) + ";  var size = math.size(obj).valueOf();  return math.subset(    obj,     math.index(" + f.join(", ") + ")    " + (r ? ", " + r : "") + "  );})()" : "math.subset(" + this.object._compile(e) + ",math.index(" + f.join(", ") + ")" + (r ? ", " + r : "") + ")"
		}, t.prototype.find = function (e) {
			var r = [];
		...
		var i = n(157), o = n(149), a = n(155), s = n(153), u = n(284);
		t.prototype = new i, t.prototype.type = "OperatorNode", t.prototype._compile = function (e) {
			...
			this.match(e) && r.push(this);
			var n = this.params;
			if (n)for (var t = 0, i = n.length; i > t; t++)r = r.concat(n[t].find(e));
			return r
		}, t.prototype.toString = function () {
			var e = this.params;
			switch (e.length) {
			...
			var e = this.params, r = u.toOperator(this.op), n = e[0], i = e[1];
			switch (e.length) {
				case 1:
					return "-" === this.op || "+" === this.op ? this.op + n.toTex() : n.toTex() + this.op;
				case 2:
					var f = n.toTex(), c = !1, l = i.toTex(), p = !1, m = "", h = "";
					switch (this.op) {
						case"/":
							m = r, r = "";
							break;
						case"*":
							n instanceof t && ("+" === n.op || "-" === n.op) && (c = !0), i instanceof t && ("+" === i.op || "-" === i.op ? p = !0 : "*" === i.op && (p = !0)), r = (n instanceof o || n instanceof t) && (i instanceof o || i instanceof t) ? " \\cdot " : " \\, ";
							break;
						case"^":
							n instanceof t || n instanceof s ? c = !0 : n instanceof a && (c = null);
							break;
						case"to":
							l = u.toUnit(l, !0)
					}
					return f = u.addBraces(f, c), l = u.addBraces(l, p), m + f + r + l + h;
				default:
					return r + "(" + this.params.map(u.toSymbol).join(", ") + ")"
			}
		}, e.exports = t
	}, function (e, r, n) {
		"use strict";
		function t(e, r) {
			if (!(this instanceof t))throw new SyntaxError("Constructor must be called with the new operator");
			if (!(e instanceof i))throw new TypeError('SymbolNode expected for parameter "symbol"');
			if (!s(r) || !r.every(a))throw new TypeError('Array containing Nodes expected for parameter "params"');
			this.symbol = e, this.params = r
		}

		var i = n(157), o = n(284), a = i.isNode, s = Array.isArray;
		t.prototype = new i, t.prototype.type = "FunctionNode", t.prototype._compile = function (e) {
			var r = e.math[this.symbol.name], n = "function" == typeof r && 1 == r.rawArgs, t = this.params.map(function (r) {
				return r._compile(e)
			});
			if (n) {
				var i, o = this.symbol.name;
				do i = "p" + Math.round(1e4 * Math.random()); while (i in e);
				return e[i] = this.params, '("' + o + '" in scope ? scope["' + o + '"](' + t.join(", ") + ') : math["' + o + '"](' + i + ", math, scope))"
			}
			return this.symbol._compile(e) + "(" + t.join(", ") + ")"
		}, t.prototype.find = function (e) {
			var r = [];
			this.match(e) && r.push(this), r = r.concat(this.symbol.find(e));
			for (var n = this.params, t = 0, i = n.length; i > t; t++)r = r.concat(n[t].find(e));
			return r
		}, t.prototype.toString = function () {
			return this.symbol.toString() + "(" + this.params.join(", ") + ")"
		}, t.prototype.toTex = function () {
			return o.toParams(this)
		}, e.exports = t
	}, function (e, r, n) {
		"use strict";
		function t(e) {
		...
		t.prototype = new i, t.prototype.type = "RangeNode", t.prototype._compile = function (e) {
			...
			var e = this.start.toTex();
			return this.step && (e += ":" + this.step.toTex()), e += ":" + this.end.toTex()
		}, e.exports = t
	}, function (e, r, n) {
		"use strict";
		function t(e) {
		...
		var o = n(157), a = n(10), s = n(284), u = n(160).isString;
		t.prototype = new o, t.prototype.type = "SymbolNode", t.prototype._compile = function (e) {
			return e.undef = i, e.Unit = a, this.name in e.math ? '("' + this.name + '" in scope ? scope["' + this.name + '"] : math["' + this.name + '"])' : '("' + this.name + '" in scope ? scope["' + this.name + '"] : ' + (a.isValuelessUnit(this.name) ? 'new Unit(null, "' + this.name + '")' : 'undef("' + this.name + '")') + ")"
		}, t.prototype.toString = function () {
			return this.name
		}, t.prototype.toTex = function () {
			return s.toSymbol(this.name)
		}, e.exports = t
	}, function (e, r, n) {
		"use strict";
		function t(e, r) {
		...
		function i(e) {
			for (var r in e)if (e.hasOwnProperty(r) && r in a)throw new Error('Scope contains an illegal symbol, "' + r + '" is a reserved keyword')
		}

		function o(e) {
			var r = Object.create(e);
			for (var n in e)if (e.hasOwnProperty(n)) {
				var t = e[n], i = t && t.transform;
				i && (r[n] = i)
			}
			return r
		}
		...
		t.prototype.eval = function () {
			...
			var r = {math: o(e), _validateScope: i}, n = this._compile(r), t = Object.keys(r).map(function (e) {
				return "    var " + e + ' = defs["' + e + '"];'
			}), a = t.join(" ") + 'return {  "eval": function (scope) {    if (scope) _validateScope(scope);    scope = scope || {};    return ' + n + ";  }};", s = new Function("defs", a);
			return s(r)
			...
			if (e) {
				...
				var n = e.properties;
				if (r && n)for (var t in n)if (n.hasOwnProperty(t) && this[t] !== n[t]) {
					r = !1;
					break
				}
			}
		...
		r.transform = function (e) {
			return e instanceof t ? new t(e.index + 1, e.min + 1, e.max + 1) : e
		}
	}, function (e, r) {
		"use strict";
		...
		e.exports = function (e) {
			function r(r) {
				...
				var n = Array.prototype.slice.call(arguments, 1), o = s[r].apply(this, n);
				return function (r) {
					var n = {
						random: function (r, n, i) {
							var s, f, c;
							if (arguments.length > 3)throw new e.error.ArgumentsError("random", arguments.length, 0, 3);
							if (1 === arguments.length ? a(r) ? s = r : c = r : 2 === arguments.length ? a(r) ? (s = r, c = n) : (f = r, c = n) : (s = r, f = n, c = i), void 0 === c && (c = 1), void 0 === f && (f = 0), void 0 !== s) {
								var l = u(s.valueOf(), f, c, o);
								return s instanceof t ? new t(l) : l
							}
							return o(f, c)
						}, randomInt: function (r, n, i) {
							var o, f, c;
							if (arguments.length > 3 || arguments.length < 1)throw new e.error.ArgumentsError("randomInt", arguments.length, 1, 3);
							if (1 === arguments.length ? a(r) ? o = r : c = r : 2 === arguments.length ? a(r) ? (o = r, c = n) : (f = r, c = n) : (o = r, f = n, c = i), void 0 === f && (f = 0), void 0 !== o) {
								var l = u(o.valueOf(), f, c, s);
								return o instanceof t ? new t(l) : l
							}
							return s(f, c)
						}, pickRandom: function (r) {
							if (1 !== arguments.length)throw new e.error.ArgumentsError("pickRandom", arguments.length, 1);
							if (r instanceof t)r = r.valueOf(); else if (!Array.isArray(r))throw new e.error.UnsupportedTypeError("pickRandom", e["typeof"](r));
						...
						var i, o, a = [];
						if (e = e.slice(0), e.length > 1)for (o = 0, i = e.shift(); i > o; o++)a.push(u(e, r, n, t)); else for (o = 0, i = e.shift(); i > o; o++)a.push(t(r, n));
						return a
					};
					return n
				}(o)
			...
			var t = n(9), i = n(137), o = n(13), a = o.isCollection, s = {
				uniform: function () {
					return Math.random
				}, normal: function () {
					return function () {
		...
		"use strict";
		function t() {
			for (var e, r = Array.prototype.slice.call(arguments), n = 0, t = r.length; t > n; n++) {
				e = r[n];
		...
		function a(e) {
			return function (n) {
				if ("boolean" == typeof e[n])n = e[n] === !0 ? "\\" + n : "\\mathrm{" + n + "}"; else if ("string" == typeof e[n])n = e[n]; else if ("string" == typeof n) {
					var t = n.indexOf("_");
					-1 !== t && (n = r.toSymbol(n.substring(0, t)) + "_{" + r.toSymbol(n.substring(t + 1)) + "}")
				}
				return n
			}
		}

		var s = n(145), u = n(152), f = {
			Alpha: "A",
			alpha: !0,
			Beta: "B",
			beta: !0,
			...
			Omega: !0,
			omega: !0
		}, c = {dots: !0, ldots: !0, cdots: !0, vdots: !0, ddots: !0, idots: !0}, l = {
			"true": "\\mathrm{True}",
			"false": "\\mathrm{False}"
		}, p = {
			inf: "\\infty",
		...
		t(m, h, f, c, l, p), r.isSymbol = o(x), r.toSymbol = a(x), r.isFunction = o(m), r.toFunction = a(m), r.isCurlyFunction = o(h), r.toCurlyFunction = a(h), r.isOperator = o(g), r.toOperator = a(g), r.isUnit = o(d), r.toUnit = function () {
			var e = a(d);
			return function (n, t) {
				return r.isUnit(n) ? e(n) : (t ? "" : "\\,") + "\\mathrm{" + n + "}"
			}
		}(), r.addBraces = function (e, r, n) {
			if (null === r)return e;
			var t = ["", ""];
			switch (n = n || "normal", "undefined" == typeof r || r === !1 ? t = ["{", "}"] : r === !0 ? (t = ["(", ")"], n = "lr") : t = Array.isArray(r) && 2 === r.length ? r : [r, r], n) {
				case"normal":
				case!1:
					return t[0] + e + t[1];
				case"lr":
				...
				case"be":
					return "\\begin{" + t[0] + "}" + e + "\\end{" + t[1] + "}"
			}
			return t[0] + e + t[1]
		}, r.toParams = function (e) {
			var n = e.symbol, t = e.params, i = n.toTex(), o = null, a = null, f = !1, c = !1, l = "", p = "", m = null;
			switch (n.name) {
				case"add":
					m = "+";
					break;
				...
				case"permutations":
					if (1 !== t.length) {
						var h = t[0].toTex(), g = t[1].toTex();
						return "\\frac{" + h + "!}{\\left(" + h + " - " + g + "\\right)!}"
					}
					m = "!";
					break;
				case"combinations":
				...
				case"abs":
					...
					break;
				case"norm":
					if (a = "\\|", f = "lr", 2 === t.length) {
						var d = t[1].toTex();
						"\\text{inf}" === d ? d = "\\infty" : "\\text{-inf}" === d ? d = "{- \\infty}" : "\\text{fro}" === d && (d = "F"), p = "_{" + d + "}", t = [t[0]]
					}
					break;
				case"ceil":
					a = ["\\lceil", "\\rceil"], f = "lr";
					break;
				case"floor":
					a = ["\\lfloor", "\\rfloor"], f = "lr";
					break;
				case"round":
					a = ["\\lfloor", "\\rceil"], f = "lr", 2 === t.length && (p = "_" + r.addBraces(t[1].toTex()), t = [t[0]]);
					break;
				case"inv":
					p = "^{-1}";
					break;
				...
				case"log":
					var x = "e";
					2 === t.length && (x = t[1].toTex(), i = "\\log_{" + x + "}", t = [t[0]]), "e" === x && (i = "\\ln"), c = !0;
					break;
				case"square":
					p = "^{2}";
					break;
				...
				case"eye":
					...
					break;
				case"det":
					if (e.params[0]instanceof s)return e.params[0].toTex("vmatrix");
					a = "vmatrix", f = "be";
					break;
				default:
					c = !0
			}
			return null !== m ? (a = "+" === m || "-" === m, o = new u(m, n.name, t).toTex()) : m = ", ", null !== a || r.isCurlyFunction(n.name) || (a = !0), o = o || t.map(function (e) {
				return "{" + e.toTex() + "}"
			}).join(m), l + (c ? i : "") + r.addBraces(o, a, f) + p
		}
	}])
});
